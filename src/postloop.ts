...
cliExecute("pull * bottle of rum");
cliExecute("pull * elemental caipiroska");
...
cliExecute("pull * PirateRealm party hat");
...
cliExecute("pull * Red Roger's red left foot");
cliExecute("pull * Red Roger's red right foot");
...
cliExecute("pull * ice hotel bell");
