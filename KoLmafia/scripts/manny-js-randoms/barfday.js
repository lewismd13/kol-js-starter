...
__webpack_require__.d(__webpack_exports__, {
  "calculateFarmingTurns": () => (/* binding */ calculateFarmingTurns)
});
...
function gingerBread() {
  ...
  if ((0,dist.get)("_gingerbreadCityTurns") === 0) {
    if (!(0,dist.get)("_gingerbreadClockAdvanced")) {
      (0,external_kolmafia_.visitUrl)("adventure.php?snarfblat=477");
      (0,external_kolmafia_.runChoice)(1); // advance clock
    }

    if ((0,dist.get)("_banderRunaways") < 5) {
      (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(_templateObject37 || (_templateObject37 = _taggedTemplateLiteral(["Frumious Bandersnatch"]))));
      (0,external_kolmafia_.maximize)("familiar weight", false);
      ensureEffect((0,dist.$effect)(_templateObject38 || (_templateObject38 = _taggedTemplateLiteral(["Blood Bond"]))));
      ensureEffect((0,dist.$effect)(_templateObject39 || (_templateObject39 = _taggedTemplateLiteral(["Leash of Linguini"]))));
      ensureEffect((0,dist.$effect)(_templateObject40 || (_templateObject40 = _taggedTemplateLiteral(["Empathy"]))));
      ensureOde(2);
      setChoice(1204, 1); // noon at the train station, get candies

      setChoice(1203, 4); // midnight at the civic center, buy cigarettes

      while ((0,dist.get)("_gingerbreadCityTurns") < 5) {
        (0,dist.adventureMacro)((0,dist.$location)(_templateObject41 || (_templateObject41 = _taggedTemplateLiteral(["Gingerbread Train Station"]))), dist.Macro.step("runaway"));
      }

      while ((0,dist.get)("_gingerbreadCityTurns") < 15) {
        (0,dist.adventureMacro)((0,dist.$location)(_templateObject42 || (_templateObject42 = _taggedTemplateLiteral(["Gingerbread Civic Center"]))), dist.Macro.step("runaway"));
      }
    }
  }
...
function checkFax() {
  ...
  if ((0,dist.get)("photocopyMonster") === (0,dist.$monster)(_templateObject93 || (_templateObject93 = _taggedTemplateLiteral(["Knob Goblin Embezzler"])))) return true;
...
function embezzlerChain() {
  if ((0,dist.get)("_pocketProfessorLectures") === 0 && (0,dist.get)("_photocopyUsed") === false) {
    (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(_templateObject101 || (_templateObject101 = _taggedTemplateLiteral(["Pocket Professor"]))));
    (0,external_kolmafia_.equip)((0,dist.$item)(_templateObject102 || (_templateObject102 = _taggedTemplateLiteral(["Pocket Professor memory chip"]))));
    (0,external_kolmafia_.maximize)("familiar weight +equip pocket professor memory chip", false);
    (0,external_kolmafia_.equip)((0,dist.$item)(_templateObject103 || (_templateObject103 = _taggedTemplateLiteral(["duct tape shirt"]))));
    (0,external_kolmafia_.useSkill)(2, (0,dist.$skill)(_templateObject104 || (_templateObject104 = _taggedTemplateLiteral(["Blood Bond"]))));
    (0,external_kolmafia_.useSkill)(2, (0,dist.$skill)(_templateObject105 || (_templateObject105 = _taggedTemplateLiteral(["Leash of Linguini"]))));
    (0,external_kolmafia_.useSkill)(2, (0,dist.$skill)(_templateObject106 || (_templateObject106 = _taggedTemplateLiteral(["Empathy of the Newt"])))); // useSkill(2, $skill`polka of plenty`);
    // useSkill(2, $skill`disco leer`);
    // sweetSynthesis($item`milk stud`, $item`swizzler`);

    (0,external_kolmafia_.cliExecute)("witchess");
    (0,external_kolmafia_.cliExecute)("beach head 10");

    if ((0,dist.get)("boomBoxSong") !== "Total Eclipse of Your Meat") {
      (0,external_kolmafia_.cliExecute)("boombox meat");
    }

    dist.Macro.trySkill((0,dist.$skill)(_templateObject107 || (_templateObject107 = _taggedTemplateLiteral(["lecture on relativity"])))).skill((0,dist.$skill)(_templateObject108 || (_templateObject108 = _taggedTemplateLiteral(["Sing Along"])))).skill((0,dist.$skill)(_templateObject109 || (_templateObject109 = _taggedTemplateLiteral(["Candyblast"])))).repeat().setAutoAttack();
    ...
    (0,external_kolmafia_.use)(1, (0,dist.$item)(_templateObject110 || (_templateObject110 = _taggedTemplateLiteral(["photocopied monster"]))));
    ...
    (0,external_kolmafia_.print)("I think you already copied embezzlers, bud", "red");
  }
}
...
;// CONCATENATED MODULE: ./src/barfday.ts
var barfday_templateObject, barfday_templateObject2, barfday_templateObject3, barfday_templateObject4, barfday_templateObject5, barfday_templateObject6, barfday_templateObject7, barfday_templateObject8, barfday_templateObject9, barfday_templateObject10, barfday_templateObject11, barfday_templateObject12, barfday_templateObject13, barfday_templateObject14, barfday_templateObject15, barfday_templateObject16, barfday_templateObject17, barfday_templateObject18, barfday_templateObject19, barfday_templateObject20, barfday_templateObject21, barfday_templateObject22, barfday_templateObject23, barfday_templateObject24, barfday_templateObject25, barfday_templateObject26, barfday_templateObject27, barfday_templateObject28, barfday_templateObject29, barfday_templateObject30, barfday_templateObject31, barfday_templateObject32, barfday_templateObject33, barfday_templateObject34, barfday_templateObject35, barfday_templateObject36, barfday_templateObject37, barfday_templateObject38, barfday_templateObject39, barfday_templateObject40, barfday_templateObject41, barfday_templateObject42, barfday_templateObject43, barfday_templateObject44, barfday_templateObject45, barfday_templateObject46, barfday_templateObject47, barfday_templateObject48, barfday_templateObject49, barfday_templateObject50, barfday_templateObject51, barfday_templateObject52, barfday_templateObject53, barfday_templateObject54, barfday_templateObject55, barfday_templateObject56, barfday_templateObject57, barfday_templateObject58, barfday_templateObject59, barfday_templateObject60, barfday_templateObject61, barfday_templateObject62, barfday_templateObject63, barfday_templateObject64, barfday_templateObject65, barfday_templateObject66, barfday_templateObject67, barfday_templateObject68, barfday_templateObject69, barfday_templateObject70, barfday_templateObject71, barfday_templateObject72, barfday_templateObject73, barfday_templateObject74, barfday_templateObject75, barfday_templateObject76, barfday_templateObject77, barfday_templateObject78, barfday_templateObject79, barfday_templateObject80, barfday_templateObject81, barfday_templateObject82, barfday_templateObject83, barfday_templateObject84, barfday_templateObject85, barfday_templateObject86, barfday_templateObject87, barfday_templateObject88, barfday_templateObject89, barfday_templateObject90, barfday_templateObject91, barfday_templateObject92, barfday_templateObject93, barfday_templateObject94, barfday_templateObject95, barfday_templateObject96, barfday_templateObject97, barfday_templateObject98, barfday_templateObject99, barfday_templateObject100, barfday_templateObject101, barfday_templateObject102, barfday_templateObject103, barfday_templateObject104, barfday_templateObject105, barfday_templateObject106, barfday_templateObject107, barfday_templateObject108, barfday_templateObject109, barfday_templateObject110, barfday_templateObject111, barfday_templateObject112, barfday_templateObject113, barfday_templateObject114, barfday_templateObject115, barfday_templateObject116, barfday_templateObject117, barfday_templateObject118, barfday_templateObject119, barfday_templateObject120, barfday_templateObject121, _templateObject122, _templateObject123, _templateObject124, _templateObject125, _templateObject126, _templateObject127, _templateObject128, _templateObject129, _templateObject130, _templateObject131, _templateObject132, _templateObject133, _templateObject134, _templateObject135, _templateObject136, _templateObject137, _templateObject138, _templateObject139, _templateObject140, _templateObject141, _templateObject142, _templateObject143, _templateObject144, _templateObject145, _templateObject146, _templateObject147, _templateObject148, _templateObject149, _templateObject150, _templateObject151, _templateObject152, _templateObject153, _templateObject154, _templateObject155, _templateObject156, _templateObject157, _templateObject158, _templateObject159, _templateObject160, _templateObject161, _templateObject162, _templateObject163, _templateObject164, _templateObject165, _templateObject166, _templateObject167, _templateObject168, _templateObject169, _templateObject170, _templateObject171;

function barfday_createForOfIteratorHelper(o, allowArrayLike) { var it = typeof Symbol !== "undefined" && o[Symbol.iterator] || o["@@iterator"]; if (!it) { if (Array.isArray(o) || (it = barfday_unsupportedIterableToArray(o)) || allowArrayLike && o && typeof o.length === "number") { if (it) o = it; var i = 0; var F = function F() {}; return { s: F, n: function n() { if (i >= o.length) return { done: true }; return { done: false, value: o[i++] }; }, e: function e(_e) { throw _e; }, f: F }; } throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); } var normalCompletion = true, didErr = false, err; return { s: function s() { it = it.call(o); }, n: function n() { var step = it.next(); normalCompletion = step.done; return step; }, e: function e(_e2) { didErr = true; err = _e2; }, f: function f() { try { if (!normalCompletion && it.return != null) it.return(); } finally { if (didErr) throw err; } } }; }

function barfday_unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return barfday_arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return barfday_arrayLikeToArray(o, minLen); }

function barfday_arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) { arr2[i] = arr[i]; } return arr2; }

function barfday_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }
...
function calculateFarmingTurns() {
  ...
  if ((0,external_kolmafia_.inebrietyLimit)() === 20) {
    return 540;
  } else {
    return 510;
  }
...
if ((0,external_kolmafia_.availableAmount)((0,dist.$item)(barfday_templateObject || (barfday_templateObject = barfday_taggedTemplateLiteral(["pantogram pants"])))) === 0) {
  (0,external_kolmafia_.cliExecute)("acquire 1 porquoise");
  (0,external_kolmafia_.use)((0,dist.$item)(barfday_templateObject2 || (barfday_templateObject2 = barfday_taggedTemplateLiteral(["disassembled clover"]))));
  (0,external_kolmafia_.cliExecute)("pantogram high meat|hilarity|silent");
}
...
if ((0,external_kolmafia_.itemAmount)((0,dist.$item)(barfday_templateObject3 || (barfday_templateObject3 = barfday_taggedTemplateLiteral(["hobo nickel"])))) > 0) {
...
if ((0,external_kolmafia_.myInebriety)() === 0) {
  ...
  (0,external_kolmafia_.drinksilent)(3, (0,dist.$item)(barfday_templateObject15 || (barfday_templateObject15 = barfday_taggedTemplateLiteral(["Frosty's frosty mug"]))));
  ...
  (0,external_kolmafia_.sweetSynthesis)((0,dist.$item)(barfday_templateObject18 || (barfday_templateObject18 = barfday_taggedTemplateLiteral(["box of Dweebs"]))), (0,dist.$item)(barfday_templateObject19 || (barfday_templateObject19 = barfday_taggedTemplateLiteral(["PEEZ dispenser"]))));
  (0,external_kolmafia_.sweetSynthesis)((0,dist.$item)(barfday_templateObject20 || (barfday_templateObject20 = barfday_taggedTemplateLiteral(["box of Dweebs"]))), (0,dist.$item)(barfday_templateObject21 || (barfday_templateObject21 = barfday_taggedTemplateLiteral(["PEEZ dispenser"]))));
  (0,external_kolmafia_.sweetSynthesis)((0,dist.$item)(barfday_templateObject22 || (barfday_templateObject22 = barfday_taggedTemplateLiteral(["box of Dweebs"]))), (0,dist.$item)(barfday_templateObject23 || (barfday_templateObject23 = barfday_taggedTemplateLiteral(["PEEZ dispenser"]))));

  if ((0,external_kolmafia_.inebrietyLimit)() === 20 && (0,external_kolmafia_.myInebriety)() === 15) {
    (0,external_kolmafia_.drinksilent)(1, (0,dist.$item)(barfday_templateObject24 || (barfday_templateObject24 = barfday_taggedTemplateLiteral(["Frosty's frosty mug"]))));
    (0,external_kolmafia_.drinksilent)(1, (0,dist.$item)(barfday_templateObject25 || (barfday_templateObject25 = barfday_taggedTemplateLiteral(["jar of fermented pickle juice"]))));
    (0,external_kolmafia_.chew)(1, (0,dist.$item)(barfday_templateObject26 || (barfday_templateObject26 = barfday_taggedTemplateLiteral(["voodoo snuff"]))));
    (0,external_kolmafia_.sweetSynthesis)((0,dist.$item)(barfday_templateObject27 || (barfday_templateObject27 = barfday_taggedTemplateLiteral(["box of Dweebs"]))), (0,dist.$item)(barfday_templateObject28 || (barfday_templateObject28 = barfday_taggedTemplateLiteral(["PEEZ dispenser"]))));
    (0,external_kolmafia_.sweetSynthesis)((0,dist.$item)(barfday_templateObject29 || (barfday_templateObject29 = barfday_taggedTemplateLiteral(["box of Dweebs"]))), (0,dist.$item)(barfday_templateObject30 || (barfday_templateObject30 = barfday_taggedTemplateLiteral(["PEEZ dispenser"]))));
  }
}

if ((0,external_kolmafia_.mySpleenUse)() === (0,external_kolmafia_.spleenLimit)() && (0,external_kolmafia_.haveEffect)((0,dist.$effect)(barfday_templateObject31 || (barfday_templateObject31 = barfday_taggedTemplateLiteral(["Eau d' Clochard"])))) === 0 && (0,dist.get)("currentMojoFilters") < 3) {
  (0,external_kolmafia_.retrieveItem)((0,dist.$item)(barfday_templateObject32 || (barfday_templateObject32 = barfday_taggedTemplateLiteral(["mojo filter"]))));
  (0,external_kolmafia_.use)((0,dist.$item)(barfday_templateObject33 || (barfday_templateObject33 = barfday_taggedTemplateLiteral(["mojo filter"]))));
  (0,external_kolmafia_.retrieveItem)((0,dist.$item)(barfday_templateObject34 || (barfday_templateObject34 = barfday_taggedTemplateLiteral(["beggin' cologne"]))));
  (0,external_kolmafia_.use)((0,dist.$item)(barfday_templateObject35 || (barfday_templateObject35 = barfday_taggedTemplateLiteral(["beggin' cologne"]))));
}
...
if ((0,dist.get)("_essentialTofuUsed") === false) {
  (0,external_kolmafia_.buy)(1, (0,dist.$item)(barfday_templateObject38 || (barfday_templateObject38 = barfday_taggedTemplateLiteral(["essential tofu"]))), 5000);
  (0,external_kolmafia_.use)((0,dist.$item)(barfday_templateObject39 || (barfday_templateObject39 = barfday_taggedTemplateLiteral(["essential tofu"]))));
...
if (!(0,dist.get)("_mimeArmyShotglassUsed") && !(0,dist.get)("_syntheticDogHairPillUsed")) {
  (0,external_kolmafia_.use)(1, (0,dist.$item)(barfday_templateObject40 || (barfday_templateObject40 = barfday_taggedTemplateLiteral(["synthetic dog hair pill"]))));
...
if ((0,dist.get)("_sausagesEaten") === 0) {
  (0,external_kolmafia_.eatsilent)(20, (0,dist.$item)(barfday_templateObject46 || (barfday_templateObject46 = barfday_taggedTemplateLiteral(["magical sausage"]))));
...
(0,external_kolmafia_.getFuel)() < calculateFarmingTurns() / 30 * 37 && (0,external_kolmafia_.haveEffect)((0,dist.$effect)(barfday_templateObject47 || (barfday_templateObject47 = barfday_taggedTemplateLiteral(["Driving Observantly"])))) < calculateFarmingTurns()) {
  (0,external_kolmafia_.cliExecute)("asdonmartin fuel 1 pie man was not meant to eat");
} // ash import AsdonMartinGUI.ash; asdonFuelUpTo(xxx);


while ((0,external_kolmafia_.haveEffect)((0,dist.$effect)(barfday_templateObject48 || (barfday_templateObject48 = barfday_taggedTemplateLiteral(["Driving Observantly"])))) < calculateFarmingTurns()) {
...
if ((0,dist.get)("_sausagesEaten") === 20) {
  (0,external_kolmafia_.eatsilent)(3, (0,dist.$item)(barfday_templateObject57 || (barfday_templateObject57 = barfday_taggedTemplateLiteral(["magical sausage"]))));
}

while ((0,external_kolmafia_.haveEffect)((0,dist.$effect)(barfday_templateObject58 || (barfday_templateObject58 = barfday_taggedTemplateLiteral(["Fat Leon's Phat Loot Lyric"])))) < calculateFarmingTurns()) {
  (0,external_kolmafia_.useSkill)((0,dist.$skill)(barfday_templateObject59 || (barfday_templateObject59 = barfday_taggedTemplateLiteral(["Fat Leon's Phat Loot Lyric"]))), 5);
}
...
if ((0,dist.get)("_pantsgivingFullness") === 1 && (0,external_kolmafia_.myFullness)() < (0,external_kolmafia_.fullnessLimit)()) {
  if (!(0,dist.get)("_distentionPillUsed")) {
    (0,external_kolmafia_.use)(1, (0,dist.$item)(barfday_templateObject79 || (barfday_templateObject79 = barfday_taggedTemplateLiteral(["distention pill"]))));
    (0,external_kolmafia_.eatsilent)(1, (0,dist.$item)(barfday_templateObject80 || (barfday_templateObject80 = barfday_taggedTemplateLiteral(["tin cup of mulligan stew"]))));
  } else {
    (0,external_kolmafia_.eatsilent)(1, (0,dist.$item)(barfday_templateObject81 || (barfday_templateObject81 = barfday_taggedTemplateLiteral(["jumping horseradish"]))));
  }
}
...
if ((0,dist.get)("_mummeryMods") !== "Meat Drop: [30*fam(Robortender)],") {
...
if ((0,dist.get)("_saberMod") === 0) {
  ...
  (0,external_kolmafia_.runChoice)(4);
} else if ((0,dist.get)("_saberMod") !== 4) {
...
if ((0,external_kolmafia_.availableAmount)((0,dist.$item)(barfday_templateObject92 || (barfday_templateObject92 = barfday_taggedTemplateLiteral(["haiku katana"])))) === 0) {
  (0,external_kolmafia_.takeStash)((0,dist.$item)(barfday_templateObject93 || (barfday_templateObject93 = barfday_taggedTemplateLiteral(["haiku katana"]))), 1);
}
...
if ((0,dist.get)("_backUpUses") === 10 && (0,external_kolmafia_.getProperty)("lastCopyableMonster") === (0,dist.$monster)(barfday_templateObject116 || (barfday_templateObject116 = barfday_taggedTemplateLiteral(["Knob Goblin Embezzler"]))).name) {
  ...
  (0,dist.adventureMacroAuto)((0,dist.$location)(barfday_templateObject118 || (barfday_templateObject118 = barfday_taggedTemplateLiteral(["Noob Cave"]))), dist.Macro.trySkill((0,dist.$skill)(barfday_templateObject119 || (barfday_templateObject119 = barfday_taggedTemplateLiteral(["Back-Up to your Last Enemy"])))).trySkill((0,dist.$skill)(barfday_templateObject120 || (barfday_templateObject120 = barfday_taggedTemplateLiteral(["Digitize"])))) // eslint-disable-next-line libram/verify-constants
  .trySkill((0,dist.$skill)(barfday_templateObject121 || (barfday_templateObject121 = barfday_taggedTemplateLiteral(["7168"])))) // wink
...
(0,external_kolmafia_.equip)((0,dist.$item)(_templateObject141 || (_templateObject141 = barfday_taggedTemplateLiteral(["none"]))), (0,dist.$slot)(_templateObject142 || (_templateObject142 = barfday_taggedTemplateLiteral(["back"]))));
(0,external_kolmafia_.equip)((0,dist.$item)(_templateObject143 || (_templateObject143 = barfday_taggedTemplateLiteral(["none"]))), (0,dist.$slot)(_templateObject144 || (_templateObject144 = barfday_taggedTemplateLiteral(["weapon"]))));

if ((0,external_kolmafia_.availableAmount)((0,dist.$item)(_templateObject145 || (_templateObject145 = barfday_taggedTemplateLiteral(["haiku katana"])))) > 0) {
...
while ((0,external_kolmafia_.availableAmount)((0,dist.$item)(_templateObject149 || (_templateObject149 = barfday_taggedTemplateLiteral(["Pok\xE9-Gro fertilizer"])))) > 1) {
  (0,external_kolmafia_.cliExecute)("grow");
}
...
(0,external_kolmafia_.autosell)((0,dist.$item)(_templateObject150 || (_templateObject150 = barfday_taggedTemplateLiteral(["cheap sunglasses"]))), (0,external_kolmafia_.availableAmount)((0,dist.$item)(_templateObject151 || (_templateObject151 = barfday_taggedTemplateLiteral(["cheap sunglasses"])))) - 1);
(0,external_kolmafia_.autosell)((0,dist.$item)(_templateObject152 || (_templateObject152 = barfday_taggedTemplateLiteral(["filthy child leash"]))), (0,external_kolmafia_.availableAmount)((0,dist.$item)(_templateObject153 || (_templateObject153 = barfday_taggedTemplateLiteral(["filthy child leash"])))));
(0,external_kolmafia_.use)((0,external_kolmafia_.availableAmount)((0,dist.$item)(_templateObject154 || (_templateObject154 = barfday_taggedTemplateLiteral(["bag of park garbage"])))) - 30, (0,dist.$item)(_templateObject155 || (_templateObject155 = barfday_taggedTemplateLiteral(["bag of park garbage"]))));
(0,external_kolmafia_.use)((0,external_kolmafia_.availableAmount)((0,dist.$item)(_templateObject156 || (_templateObject156 = barfday_taggedTemplateLiteral(["Gathered Meat-Clip"])))), (0,dist.$item)(_templateObject157 || (_templateObject157 = barfday_taggedTemplateLiteral(["Gathered Meat-Clip"]))));
(0,external_kolmafia_.autosell)((0,dist.$item)(_templateObject158 || (_templateObject158 = barfday_taggedTemplateLiteral(["expensive camera"]))), (0,external_kolmafia_.availableAmount)((0,dist.$item)(_templateObject159 || (_templateObject159 = barfday_taggedTemplateLiteral(["expensive camera"])))));
(0,external_kolmafia_.autosell)((0,dist.$item)(_templateObject160 || (_templateObject160 = barfday_taggedTemplateLiteral(["bag of gross foreign snacks"]))), (0,external_kolmafia_.availableAmount)((0,dist.$item)(_templateObject161 || (_templateObject161 = barfday_taggedTemplateLiteral(["bag of gross foreign snacks"])))));
(0,external_kolmafia_.putShop)(300, 0, (0,external_kolmafia_.availableAmount)((0,dist.$item)(_templateObject162 || (_templateObject162 = barfday_taggedTemplateLiteral(["gold nuggets"])))), (0,dist.$item)(_templateObject163 || (_templateObject163 = barfday_taggedTemplateLiteral(["gold nuggets"]))));
(0,external_kolmafia_.putShop)(0, 0, (0,external_kolmafia_.availableAmount)((0,dist.$item)(_templateObject164 || (_templateObject164 = barfday_taggedTemplateLiteral(["cornucopia"])))), (0,dist.$item)(_templateObject165 || (_templateObject165 = barfday_taggedTemplateLiteral(["cornucopia"]))));
(0,external_kolmafia_.putShop)(0, 0, (0,external_kolmafia_.availableAmount)((0,dist.$item)(_templateObject166 || (_templateObject166 = barfday_taggedTemplateLiteral(["elemental sugarcube"])))), (0,dist.$item)(_templateObject167 || (_templateObject167 = barfday_taggedTemplateLiteral(["elemental sugarcube"]))));
(0,external_kolmafia_.autosell)((0,dist.$item)(_templateObject168 || (_templateObject168 = barfday_taggedTemplateLiteral(["meat stack"]))), (0,external_kolmafia_.itemAmount)((0,dist.$item)(_templateObject169 || (_templateObject169 = barfday_taggedTemplateLiteral(["meat stack"])))));
...
/******/ 	var __webpack_exports__ = __webpack_require__(__webpack_require__.s = 1866);
