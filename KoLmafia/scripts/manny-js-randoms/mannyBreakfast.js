...
function mannyQuestVolcoino() {
  ...
  if ((0,dist.get)("_volcanoItem2") === 8425) {
    (0,external_kolmafia_.retrieveItem)(5, (0,dist.$item)(_templateObject110 || (_templateObject110 = _taggedTemplateLiteral(["New Age healing crystal"]))));
    (0,external_kolmafia_.visitUrl)("place.php?whichplace=airport_hot&action=airport4_questhub");
    (0,external_kolmafia_.runChoice)(2);
  } else if ((0,dist.get)("_volcanoItem3") === 8446) {
    (0,external_kolmafia_.retrieveItem)(1, (0,dist.$item)(_templateObject111 || (_templateObject111 = _taggedTemplateLiteral(["SMOOCH bottlecap"]))));
    (0,external_kolmafia_.visitUrl)("place.php?whichplace=airport_hot&action=airport4_questhub");
    (0,external_kolmafia_.runChoice)(3);
  } else if ((0,dist.get)("_volcanoItem3") === 8517) {
    (0,external_kolmafia_.retrieveItem)(3, (0,dist.$item)(_templateObject112 || (_templateObject112 = _taggedTemplateLiteral(["SMOOCH bracers"]))));
    (0,external_kolmafia_.visitUrl)("place.php?whichplace=airport_hot&action=airport4_questhub");
    (0,external_kolmafia_.runChoice)(3);
  } else if ((0,dist.get)("_volcanoItem1") === 8470) {
    (0,external_kolmafia_.retrieveItem)(5, (0,dist.$item)(_templateObject113 || (_templateObject113 = _taggedTemplateLiteral(["gooey lava globs"]))));
    (0,external_kolmafia_.visitUrl)("place.php?whichplace=airport_hot&action=airport4_questhub");
    (0,external_kolmafia_.runChoice)(1);
  } else if ((0,dist.get)("_volcanoItem1") === 8516) {
    (0,external_kolmafia_.retrieveItem)(3, (0,dist.$item)(_templateObject114 || (_templateObject114 = _taggedTemplateLiteral(["smooth velvet bra"]))));
    (0,external_kolmafia_.visitUrl)("place.php?whichplace=airport_hot&action=airport4_questhub");
    (0,external_kolmafia_.runChoice)(1);
  } else if ((0,dist.get)("_volcanoItem1") === 8523) {
    if (!(0,dist.get)("_claraBellUsed") && (0,external_kolmafia_.itemAmount)((0,dist.$item)(_templateObject115 || (_templateObject115 = _taggedTemplateLiteral(["fused fuse"])))) === 0) {
      (0,external_kolmafia_.use)((0,dist.$item)(_templateObject116 || (_templateObject116 = _taggedTemplateLiteral(["Clara's bell"]))));
      setChoice(1091, 7);

      while ((0,external_kolmafia_.itemAmount)((0,dist.$item)(_templateObject117 || (_templateObject117 = _taggedTemplateLiteral(["fused fuse"])))) === 0) {
        (0,external_kolmafia_.adv1)((0,dist.$location)(_templateObject118 || (_templateObject118 = _taggedTemplateLiteral(["LavaCo\u2122 Lamp Factory"]))), -1, "");
      }
...
if ((0,dist.get)("_questPartyFairQuest") === "food") {
  (0,external_kolmafia_.print)("Hey, go talk to Geraldine, time for another sliderpocalypse!", "yellow");
} else if ((0,dist.get)("_questPartyFairQuest") === "booze") {
  (0,external_kolmafia_.print)("Hey, go talk to Gerald, get that jarmageddon!", "yellow");
}
