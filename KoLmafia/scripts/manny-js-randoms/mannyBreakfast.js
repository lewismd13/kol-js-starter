...
function mannyQuestVolcoino() {
  ...
  if ((0,dist.get)("_volcanoItem2") === 8425) {
    (0,external_kolmafia_.retrieveItem)(5, (0,dist.$item)(_templateObject111 || (_templateObject111 = _taggedTemplateLiteral(["New Age healing crystal"]))));
    (0,external_kolmafia_.visitUrl)("place.php?whichplace=airport_hot&action=airport4_questhub");
    (0,external_kolmafia_.runChoice)(2);
  } else if ((0,dist.get)("_volcanoItem3") === 8446) {
    (0,external_kolmafia_.retrieveItem)(1, (0,dist.$item)(_templateObject112 || (_templateObject112 = _taggedTemplateLiteral(["SMOOCH bottlecap"]))));
    (0,external_kolmafia_.visitUrl)("place.php?whichplace=airport_hot&action=airport4_questhub");
    (0,external_kolmafia_.runChoice)(3);
  } else if ((0,dist.get)("_volcanoItem3") === 8517) {
    (0,external_kolmafia_.retrieveItem)(3, (0,dist.$item)(_templateObject113 || (_templateObject113 = _taggedTemplateLiteral(["SMOOCH bracers"]))));
    (0,external_kolmafia_.visitUrl)("place.php?whichplace=airport_hot&action=airport4_questhub");
    (0,external_kolmafia_.runChoice)(3);
  } else if ((0,dist.get)("_volcanoItem1") === 8470) {
    (0,external_kolmafia_.retrieveItem)(5, (0,dist.$item)(_templateObject114 || (_templateObject114 = _taggedTemplateLiteral(["gooey lava globs"]))));
    (0,external_kolmafia_.visitUrl)("place.php?whichplace=airport_hot&action=airport4_questhub");
    (0,external_kolmafia_.runChoice)(1);
  } else if ((0,dist.get)("_volcanoItem1") === 8516) {
    (0,external_kolmafia_.retrieveItem)(3, (0,dist.$item)(_templateObject115 || (_templateObject115 = _taggedTemplateLiteral(["smooth velvet bra"]))));
    (0,external_kolmafia_.visitUrl)("place.php?whichplace=airport_hot&action=airport4_questhub");
    (0,external_kolmafia_.runChoice)(1);
  } else if ((0,dist.get)("_volcanoItem1") === 8523) {
    if (!(0,dist.get)("_claraBellUsed") && (0,external_kolmafia_.itemAmount)((0,dist.$item)(_templateObject116 || (_templateObject116 = _taggedTemplateLiteral(["fused fuse"])))) === 0) {
      (0,external_kolmafia_.use)((0,dist.$item)(_templateObject117 || (_templateObject117 = _taggedTemplateLiteral(["Clara's bell"]))));
      setChoice(1091, 7);

      while ((0,external_kolmafia_.itemAmount)((0,dist.$item)(_templateObject118 || (_templateObject118 = _taggedTemplateLiteral(["fused fuse"])))) === 0) {
        (0,external_kolmafia_.adv1)((0,dist.$location)(_templateObject119 || (_templateObject119 = _taggedTemplateLiteral(["LavaCo\u2122 Lamp Factory"]))), -1, "");
      }
      ...
      while ((0,external_kolmafia_.itemAmount)((0,dist.$item)(_templateObject120 || (_templateObject120 = _taggedTemplateLiteral(["fused fuse"])))) === 0) {
        (0,external_kolmafia_.adv1)((0,dist.$location)(_templateObject121 || (_templateObject121 = _taggedTemplateLiteral(["LavaCo\u2122 Lamp Factory"]))), -1, "");
      }
...
;// CONCATENATED MODULE: ./src/mannyBreakfast.ts
var mannyBreakfast_templateObject, mannyBreakfast_templateObject2, mannyBreakfast_templateObject3, mannyBreakfast_templateObject4, mannyBreakfast_templateObject5, mannyBreakfast_templateObject6, mannyBreakfast_templateObject7, mannyBreakfast_templateObject8, mannyBreakfast_templateObject9, mannyBreakfast_templateObject10, mannyBreakfast_templateObject11, mannyBreakfast_templateObject12, mannyBreakfast_templateObject13, mannyBreakfast_templateObject14, mannyBreakfast_templateObject15, mannyBreakfast_templateObject16, mannyBreakfast_templateObject17, mannyBreakfast_templateObject18, mannyBreakfast_templateObject19, mannyBreakfast_templateObject20, mannyBreakfast_templateObject21, mannyBreakfast_templateObject22, mannyBreakfast_templateObject23, mannyBreakfast_templateObject24, mannyBreakfast_templateObject25, mannyBreakfast_templateObject26, mannyBreakfast_templateObject27, mannyBreakfast_templateObject28, mannyBreakfast_templateObject29, mannyBreakfast_templateObject30, mannyBreakfast_templateObject31, mannyBreakfast_templateObject32, mannyBreakfast_templateObject33, mannyBreakfast_templateObject34, mannyBreakfast_templateObject35, mannyBreakfast_templateObject36, mannyBreakfast_templateObject37, mannyBreakfast_templateObject38, mannyBreakfast_templateObject39, mannyBreakfast_templateObject40, mannyBreakfast_templateObject41, mannyBreakfast_templateObject42, mannyBreakfast_templateObject43, mannyBreakfast_templateObject44, mannyBreakfast_templateObject45, mannyBreakfast_templateObject46, mannyBreakfast_templateObject47, mannyBreakfast_templateObject48, mannyBreakfast_templateObject49, mannyBreakfast_templateObject50;

function mannyBreakfast_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }
...
function buyRaffle(ticketQty) {
  if ((0,external_kolmafia_.availableAmount)((0,dist.$item)(mannyBreakfast_templateObject || (mannyBreakfast_templateObject = mannyBreakfast_taggedTemplateLiteral(["raffle ticket"])))) < ticketQty && (0,external_kolmafia_.myName)() === "manendra" && (0,external_kolmafia_.containsText)((0,external_kolmafia_.visitUrl)("main.php"), "map7beach.gif") && (0,external_kolmafia_.myPath)() !== "Zombie Slayer") (0,external_kolmafia_.cliExecute)("raffle ".concat(ticketQty).concat((0,external_kolmafia_.canInteract)() ? " inventory" : " storage"));
  return (0,external_kolmafia_.availableAmount)((0,dist.$item)(mannyBreakfast_templateObject2 || (mannyBreakfast_templateObject2 = mannyBreakfast_taggedTemplateLiteral(["raffle ticket"])))) >= ticketQty;
}
...
function getFunFunds() {
  ...
  if ((0,external_kolmafia_.itemAmount)((0,dist.$item)(mannyBreakfast_templateObject3 || (mannyBreakfast_templateObject3 = mannyBreakfast_taggedTemplateLiteral(["bag of park garbage"])))) < 1) {
    if ((0,external_kolmafia_.canInteract)()) {
      (0,external_kolmafia_.buy)(1, (0,dist.$item)(mannyBreakfast_templateObject4 || (mannyBreakfast_templateObject4 = mannyBreakfast_taggedTemplateLiteral(["bag of park garbage"]))));
    } else {
      (0,external_kolmafia_.takeStorage)(1, (0,dist.$item)(mannyBreakfast_templateObject5 || (mannyBreakfast_templateObject5 = mannyBreakfast_taggedTemplateLiteral(["bag of park garbage"]))));
    }
  }

  if ((0,external_kolmafia_.itemAmount)((0,dist.$item)(mannyBreakfast_templateObject6 || (mannyBreakfast_templateObject6 = mannyBreakfast_taggedTemplateLiteral(["bag of park garbage"])))) >= 1) {
...
dist.Clan.join(40382);
(0,external_kolmafia_.cliExecute)("ccs libramMacro");

if ((0,dist.get)("_clipartSummons") === 0) {
  (0,external_kolmafia_.cliExecute)("create 1 borrowed time");
  (0,external_kolmafia_.cliExecute)("create 2 box of familiar jacks");
}

if ((0,external_kolmafia_.toInt)((0,external_kolmafia_.getProperty)("_daycareGymScavenges")) === 0) {
...
var raffleTix = 5 + (0,external_kolmafia_.random)(5);
buyRaffle(raffleTix);

if ((0,dist.get)("_sausagesMade") === 0) {
  (0,external_kolmafia_.cliExecute)("make 23 magical sausage");
}

while (Object.keys((0,external_kolmafia_.reverseNumberology)()).includes("69") && (0,dist.get)("_universeCalculated") < (0,dist.get)("skillLevel144")) {
  (0,external_kolmafia_.cliExecute)("numberology 69");
}

if ((0,dist.get)("_etchedHourglassUsed") === false) {
  (0,external_kolmafia_.use)((0,dist.$item)(mannyBreakfast_templateObject7 || (mannyBreakfast_templateObject7 = mannyBreakfast_taggedTemplateLiteral(["etched hourglass"]))));
}
...
if ((0,dist.get)("_deckCardsDrawn") === 0) {
  (0,external_kolmafia_.cliExecute)("cheat ancestral recall"); // cliExecute("cheat 1952");

  (0,external_kolmafia_.cliExecute)("cheat island");
}

if ((0,dist.get)("_deckCardsDrawn") < 11) {
  (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(mannyBreakfast_templateObject8 || (mannyBreakfast_templateObject8 = mannyBreakfast_taggedTemplateLiteral(["Robortender"]))));
  (0,external_kolmafia_.retrieveItem)((0,dist.$item)(mannyBreakfast_templateObject9 || (mannyBreakfast_templateObject9 = mannyBreakfast_taggedTemplateLiteral(["toggle switch (Bartend)"]))));
  (0,external_kolmafia_.equip)((0,dist.$item)(mannyBreakfast_templateObject10 || (mannyBreakfast_templateObject10 = mannyBreakfast_taggedTemplateLiteral(["toggle switch (Bartend)"]))));
  (0,external_kolmafia_.restoreMp)(150);
  dist.Macro.skill((0,dist.$skill)(mannyBreakfast_templateObject11 || (mannyBreakfast_templateObject11 = mannyBreakfast_taggedTemplateLiteral(["Curse of Weaksauce"])))).trySkillRepeat((0,dist.$skill)(mannyBreakfast_templateObject12 || (mannyBreakfast_templateObject12 = mannyBreakfast_taggedTemplateLiteral(["Saucestorm"])))).setAutoAttack();
  (0,external_kolmafia_.cliExecute)("cheat phylum elf");
  (0,external_kolmafia_.runCombat)(); // putShop(0, 0, $item`peppermint sprig`);
}

(0,external_kolmafia_.cliExecute)("shower cold");
(0,external_kolmafia_.cliExecute)("bastille mainstat brutalist gesture");
(0,external_kolmafia_.cliExecute)("briefcase collect");

if (!(0,dist.get)("_timeSpinnerReplicatorUsed")) {
  (0,external_kolmafia_.cliExecute)("farfuture gin");
}
...
(0,external_kolmafia_.visitUrl)("place.php?whichplace=chateau&action=chateau_desk1"); // Upgrade saber for fam wt
...
(0,external_kolmafia_.retrieveItem)(5, (0,dist.$item)(mannyBreakfast_templateObject13 || (mannyBreakfast_templateObject13 = mannyBreakfast_taggedTemplateLiteral(["abstraction: thought"])))); // TODO: Make this not break when you run out of macros

while ((0,external_kolmafia_.toInt)((0,external_kolmafia_.getProperty)("_machineTunnelsAdv")) < 5) {
  (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(mannyBreakfast_templateObject14 || (mannyBreakfast_templateObject14 = mannyBreakfast_taggedTemplateLiteral(["Machine Elf"])))); // setAutoAttack("melfgetcertainty");

  dist.Macro.if_("monsterid 1965", dist.Macro.trySkillRepeat((0,dist.$skill)(mannyBreakfast_templateObject15 || (mannyBreakfast_templateObject15 = mannyBreakfast_taggedTemplateLiteral(["Saucestorm"]))))).while_("!monstername perceiver of sensations && hasskill macrometeorite", dist.Macro.trySkill((0,dist.$skill)(mannyBreakfast_templateObject16 || (mannyBreakfast_templateObject16 = mannyBreakfast_taggedTemplateLiteral(["Macrometeorite"])))).skill((0,dist.$skill)(mannyBreakfast_templateObject17 || (mannyBreakfast_templateObject17 = mannyBreakfast_taggedTemplateLiteral(["Summon Love Mosquito"]))))).if_("monstername perceiver of sensations", dist.Macro.tryItem((0,dist.$item)(mannyBreakfast_templateObject18 || (mannyBreakfast_templateObject18 = mannyBreakfast_taggedTemplateLiteral(["abstraction: thought"])))).trySkillRepeat((0,dist.$skill)(mannyBreakfast_templateObject19 || (mannyBreakfast_templateObject19 = mannyBreakfast_taggedTemplateLiteral(["Saucestorm"]))))).trySkillRepeat((0,dist.$skill)(mannyBreakfast_templateObject20 || (mannyBreakfast_templateObject20 = mannyBreakfast_taggedTemplateLiteral(["Saucestorm"])))).setAutoAttack();
  (0,external_kolmafia_.adv1)((0,dist.$location)(mannyBreakfast_templateObject21 || (mannyBreakfast_templateObject21 = mannyBreakfast_taggedTemplateLiteral(["The Deep Machine Tunnels"]))), -1, "");
}

(0,external_kolmafia_.setAutoAttack)(0);
(0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(mannyBreakfast_templateObject22 || (mannyBreakfast_templateObject22 = mannyBreakfast_taggedTemplateLiteral(["Rogue Program"]))));

if ((0,external_kolmafia_.availableAmount)((0,dist.$item)(mannyBreakfast_templateObject23 || (mannyBreakfast_templateObject23 = mannyBreakfast_taggedTemplateLiteral(["Pantsgiving"])))) === 0) {
  (0,external_kolmafia_.takeStash)(1, (0,dist.$item)(mannyBreakfast_templateObject24 || (mannyBreakfast_templateObject24 = mannyBreakfast_taggedTemplateLiteral(["Pantsgiving"]))));
}

(0,external_kolmafia_.equip)((0,dist.$item)(mannyBreakfast_templateObject25 || (mannyBreakfast_templateObject25 = mannyBreakfast_taggedTemplateLiteral(["Pantsgiving"]))));

while ((0,external_kolmafia_.toInt)((0,external_kolmafia_.getProperty)("_snojoFreeFights")) < 10) {
  (0,external_kolmafia_.setAutoAttack)("gnat extract mortar weak");
  (0,external_kolmafia_.adv1)((0,dist.$location)(mannyBreakfast_templateObject26 || (mannyBreakfast_templateObject26 = mannyBreakfast_taggedTemplateLiteral(["The X-32-F Combat Training Snowman"]))), -1, "");
}

(0,external_kolmafia_.setAutoAttack)(0);
(0,external_kolmafia_.equip)((0,dist.$slot)(mannyBreakfast_templateObject27 || (mannyBreakfast_templateObject27 = mannyBreakfast_taggedTemplateLiteral(["pants"]))), (0,dist.$item)(mannyBreakfast_templateObject28 || (mannyBreakfast_templateObject28 = mannyBreakfast_taggedTemplateLiteral(["none"]))));

if ((0,external_kolmafia_.availableAmount)((0,dist.$item)(mannyBreakfast_templateObject29 || (mannyBreakfast_templateObject29 = mannyBreakfast_taggedTemplateLiteral(["Pantsgiving"])))) > 0) {
  (0,external_kolmafia_.putStash)(1, (0,dist.$item)(mannyBreakfast_templateObject30 || (mannyBreakfast_templateObject30 = mannyBreakfast_taggedTemplateLiteral(["Pantsgiving"]))));
}

(0,external_kolmafia_.use)(1, (0,dist.$item)(mannyBreakfast_templateObject31 || (mannyBreakfast_templateObject31 = mannyBreakfast_taggedTemplateLiteral(["Bird-a-Day calendar"])))); // cheesefax fortune
//BafH
//Get Free Volcoino
...
if (!(0,dist.get)("_loveTunnelUsed")) {
  (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(mannyBreakfast_templateObject32 || (mannyBreakfast_templateObject32 = mannyBreakfast_taggedTemplateLiteral(["Golden Monkey"]))));
  (0,external_kolmafia_.equip)((0,dist.$item)(mannyBreakfast_templateObject33 || (mannyBreakfast_templateObject33 = mannyBreakfast_taggedTemplateLiteral(["Fourth of May Cosplay Saber"]))));
  (0,external_kolmafia_.useSkill)((0,dist.$skill)(mannyBreakfast_templateObject34 || (mannyBreakfast_templateObject34 = mannyBreakfast_taggedTemplateLiteral(["Carol of the Bulls"]))));
  (0,external_kolmafia_.useSkill)((0,dist.$skill)(mannyBreakfast_templateObject35 || (mannyBreakfast_templateObject35 = mannyBreakfast_taggedTemplateLiteral(["Carol of the Hells"]))));
  ...
  (0,external_kolmafia_.setAutoAttack)("HCCS_LOV_tunnel");
  (0,external_kolmafia_.adv1)((0,dist.$location)(mannyBreakfast_templateObject36 || (mannyBreakfast_templateObject36 = mannyBreakfast_taggedTemplateLiteral(["The Tunnel of L.O.V.E."]))), -1, "");
  (0,external_kolmafia_.setAutoAttack)(0);
}

if ((0,external_kolmafia_.myGardenType)() === "thanksgarden" && !(0,dist.get)("_mushroomGardenVisited")) {
  (0,external_kolmafia_.cliExecute)("garden pick");
  (0,external_kolmafia_.use)(1, (0,dist.$item)(mannyBreakfast_templateObject37 || (mannyBreakfast_templateObject37 = mannyBreakfast_taggedTemplateLiteral(["packet of tall grass seeds"]))));
}

(0,external_kolmafia_.putShop)(6845, 0, (0,external_kolmafia_.availableAmount)((0,dist.$item)(mannyBreakfast_templateObject38 || (mannyBreakfast_templateObject38 = mannyBreakfast_taggedTemplateLiteral(["battery (AAA)"])))), (0,dist.$item)(mannyBreakfast_templateObject39 || (mannyBreakfast_templateObject39 = mannyBreakfast_taggedTemplateLiteral(["battery (AAA)"]))));
(0,external_kolmafia_.putShop)(0, 0, (0,external_kolmafia_.availableAmount)((0,dist.$item)(mannyBreakfast_templateObject40 || (mannyBreakfast_templateObject40 = mannyBreakfast_taggedTemplateLiteral(["cornucopia"])))), (0,dist.$item)(mannyBreakfast_templateObject41 || (mannyBreakfast_templateObject41 = mannyBreakfast_taggedTemplateLiteral(["cornucopia"]))));
(0,external_kolmafia_.putShop)(49995, 0, 3, (0,dist.$item)(mannyBreakfast_templateObject42 || (mannyBreakfast_templateObject42 = mannyBreakfast_taggedTemplateLiteral(["pocket wish"]))));

if ((0,dist.get)("_cargoPocketEmptied") === false && !(0,external_kolmafia_.containsText)((0,dist.get)("cargoPocketsEmptied"), "533")) {
  (0,external_kolmafia_.cliExecute)("cargo 533");
  (0,external_kolmafia_.putShop)(50000, 0, (0,external_kolmafia_.availableAmount)((0,dist.$item)(mannyBreakfast_templateObject43 || (mannyBreakfast_templateObject43 = mannyBreakfast_taggedTemplateLiteral(["greasy desk bell"])))), (0,dist.$item)(mannyBreakfast_templateObject44 || (mannyBreakfast_templateObject44 = mannyBreakfast_taggedTemplateLiteral(["greasy desk bell"]))));
}

if ((0,dist.get)("_chateauMonsterFought") === false) {
  (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(mannyBreakfast_templateObject45 || (mannyBreakfast_templateObject45 = mannyBreakfast_taggedTemplateLiteral(["Robortender"]))));
  (0,external_kolmafia_.retrieveItem)((0,dist.$item)(mannyBreakfast_templateObject46 || (mannyBreakfast_templateObject46 = mannyBreakfast_taggedTemplateLiteral(["toggle switch (Bartend)"]))));
  (0,external_kolmafia_.equip)((0,dist.$item)(mannyBreakfast_templateObject47 || (mannyBreakfast_templateObject47 = mannyBreakfast_taggedTemplateLiteral(["toggle switch (Bartend)"]))));
  (0,external_kolmafia_.equip)((0,dist.$item)(mannyBreakfast_templateObject48 || (mannyBreakfast_templateObject48 = mannyBreakfast_taggedTemplateLiteral(["lucky gold ring"]))), (0,dist.$slot)(mannyBreakfast_templateObject49 || (mannyBreakfast_templateObject49 = mannyBreakfast_taggedTemplateLiteral(["acc1"]))));
  (0,external_kolmafia_.restoreMp)(150);
  (0,external_kolmafia_.setAutoAttack)("gnat extract mortar weak");
  (0,external_kolmafia_.visitUrl)("place.php?whichplace=chateau&action=chateau_painting", false);
  (0,external_kolmafia_.runCombat)();
  (0,external_kolmafia_.setAutoAttack)(0); // putShop(0, 0, 1, $item`peppermint sprig`);
}
...
if ((0,dist.get)("_questPartyFairQuest") === "") {
  ...
  (0,external_kolmafia_.adv1)((0,dist.$location)(mannyBreakfast_templateObject50 || (mannyBreakfast_templateObject50 = mannyBreakfast_taggedTemplateLiteral(["The Neverending Party"]))), -1, "");
}

if ((0,dist.get)("_questPartyFairQuest") === "food") {
  (0,external_kolmafia_.print)("Hey, go talk to Geraldine, time for another sliderpocalypse!", "blue");
} else if ((0,dist.get)("_questPartyFairQuest") === "booze") {
  (0,external_kolmafia_.print)("Hey, go talk to Gerald, get that jarmageddon!", "blue");
}
...
/******/ 	var __webpack_exports__ = __webpack_require__(__webpack_require__.s = 6183);
