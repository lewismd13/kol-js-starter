...
(0,external_kolmafia_.cliExecute)("pull 1 tiny black hole");
...
(0,external_kolmafia_.cliExecute)("ccs libramMacro"); // cheesefax fortune, no longer doing this in loop

if ((0,dist.get)("_clanFortuneConsultUses") < 3) {
  dist.Clan.join("Bonus Adventures from Hell");

  while ((0,dist.get)("_clanFortuneConsultUses") < 3) {
...
(0,external_kolmafia_.putShop)(0, 0, 1, (0,dist.$item)(postloop_templateObject16 || (postloop_templateObject16 = postloop_taggedTemplateLiteral(["bag of grain"])))); // put_shop(0, 0, 1, $item[squeaky toy rose]);

(0,external_kolmafia_.putShop)(49995, 0, 3, (0,dist.$item)(postloop_templateObject17 || (postloop_templateObject17 = postloop_taggedTemplateLiteral(["pocket wish"]))));
(0,external_kolmafia_.cliExecute)("terminal enquiry familiar.enq");
setChoice(1414, 2);
(0,external_kolmafia_.useSkill)(1, (0,dist.$skill)(postloop_templateObject18 || (postloop_templateObject18 = postloop_taggedTemplateLiteral(["Lock Picking"]))));
(0,external_kolmafia_.cliExecute)("create 1 jarlsberg's key lime");
(0,external_kolmafia_.putShop)(0, 0, (0,dist.$item)(postloop_templateObject19 || (postloop_templateObject19 = postloop_taggedTemplateLiteral(["Jarlsberg's key lime"]))));

if ((0,dist.get)("_deckCardsDrawn") < 11) {
  (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(postloop_templateObject20 || (postloop_templateObject20 = postloop_taggedTemplateLiteral(["Robortender"]))));
  (0,external_kolmafia_.retrieveItem)((0,dist.$item)(postloop_templateObject21 || (postloop_templateObject21 = postloop_taggedTemplateLiteral(["toggle switch (Bartend)"]))));
  (0,external_kolmafia_.equip)((0,dist.$item)(postloop_templateObject22 || (postloop_templateObject22 = postloop_taggedTemplateLiteral(["toggle switch (Bartend)"]))));
  (0,external_kolmafia_.restoreMp)(150);
  dist.Macro.skill((0,dist.$skill)(postloop_templateObject23 || (postloop_templateObject23 = postloop_taggedTemplateLiteral(["Curse of Weaksauce"])))).trySkillRepeat((0,dist.$skill)(postloop_templateObject24 || (postloop_templateObject24 = postloop_taggedTemplateLiteral(["Saucegeyser"])))).setAutoAttack();
...
var dupeTarget = (0,dist.$item)(postloop_templateObject25 || (postloop_templateObject25 = postloop_taggedTemplateLiteral(["bottle of Greedy Dog"])));
...
if ((0,external_kolmafia_.toInt)((0,external_kolmafia_.getProperty)("encountersUntilDMTChoice")) === 0 && (0,external_kolmafia_.availableAmount)(dupeTarget) > 0) {
  (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(postloop_templateObject26 || (postloop_templateObject26 = postloop_taggedTemplateLiteral(["Machine Elf"]))));
  ...
  (0,external_kolmafia_.adv1)((0,dist.$location)(postloop_templateObject27 || (postloop_templateObject27 = postloop_taggedTemplateLiteral(["The Deep Machine Tunnels"]))), -1, ""); // putShop(0, 0, 1, $item`Karma shawarma`);
...
(0,external_kolmafia_.retrieveItem)(20, (0,dist.$item)(postloop_templateObject28 || (postloop_templateObject28 = postloop_taggedTemplateLiteral(["heat-resistant sheet metal"])))); // setAutoAttack("gnat extract mortar weak");

dist.Macro.trySkill((0,dist.$skill)(postloop_templateObject29 || (postloop_templateObject29 = postloop_taggedTemplateLiteral(["Curse of Weaksauce"])))).trySkill((0,dist.$skill)(postloop_templateObject30 || (postloop_templateObject30 = postloop_taggedTemplateLiteral(["Stuffed Mortar Shell"])))).trySkill((0,dist.$skill)(postloop_templateObject31 || (postloop_templateObject31 = postloop_taggedTemplateLiteral(["Extract"])))).setAutoAttack();

while (!(0,external_kolmafia_.containsText)((0,dist.$location)(postloop_templateObject32 || (postloop_templateObject32 = postloop_taggedTemplateLiteral(["The Bubblin' Caldera"]))).noncombatQueue, "Lava Dogs")) {
  (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(postloop_templateObject33 || (postloop_templateObject33 = postloop_taggedTemplateLiteral(["Mini-Hipster"]))));
  (0,external_kolmafia_.equip)((0,dist.$item)(postloop_templateObject34 || (postloop_templateObject34 = postloop_taggedTemplateLiteral(["Kramco Sausage-o-Matic\u2122"]))));
  (0,external_kolmafia_.adv1)((0,dist.$location)(postloop_templateObject35 || (postloop_templateObject35 = postloop_taggedTemplateLiteral(["The Bubblin' Caldera"]))));
}
...
(0,external_kolmafia_.putShop)(6845, 0, (0,external_kolmafia_.availableAmount)((0,dist.$item)(postloop_templateObject36 || (postloop_templateObject36 = postloop_taggedTemplateLiteral(["battery (AAA)"])))), (0,dist.$item)(postloop_templateObject37 || (postloop_templateObject37 = postloop_taggedTemplateLiteral(["battery (AAA)"]))));
mannyQuestVolcoino();
