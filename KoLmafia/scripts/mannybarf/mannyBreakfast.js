...
function buyRaffle(ticketQty) {
  if ((0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.availableAmount)((0,libram__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject || (_templateObject = _taggedTemplateLiteral(["raffle ticket"])))) < ticketQty && (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.myName)() === "manendra" && (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.containsText)((0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.visitUrl)("main.php"), "map7beach.gif") && (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.myPath)() !== "Zombie Slayer") (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.cliExecute)("raffle ".concat(ticketQty).concat((0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.canInteract)() ? " inventory" : " storage"));
  return (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.availableAmount)((0,libram__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["raffle ticket"])))) >= ticketQty;
}
...
function getFunFunds() {
  ...
  if ((0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.itemAmount)((0,libram__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["bag of park garbage"])))) < 1) {
    if ((0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.canInteract)()) {
      (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.buy)(1, (0,libram__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["bag of park garbage"]))));
    } else {
      (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.takeStorage)(1, (0,libram__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["bag of park garbage"]))));
    }
  }

  if ((0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.itemAmount)((0,libram__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral(["bag of park garbage"])))) >= 1) {
...
libram__WEBPACK_IMPORTED_MODULE_2__.Clan.join(40382);
(0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.cliExecute)("ccs libramMacro");

if ((0,libram__WEBPACK_IMPORTED_MODULE_2__.get)("_clipartSummons") === 0) {
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.cliExecute)("create 1 borrowed time");
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.cliExecute)("create 2 box of familiar jacks");
}

if ((0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.toInt)((0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.getProperty)("_daycareGymScavenges")) === 0) {
...
var raffleTix = 5 + (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.random)(5);
buyRaffle(raffleTix);

if ((0,libram__WEBPACK_IMPORTED_MODULE_2__.get)("_sausagesMade") === 0) {
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.cliExecute)("make 23 magical sausage");
}

while (Object.keys((0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.reverseNumberology)()).includes("69") && (0,libram__WEBPACK_IMPORTED_MODULE_2__.get)("_universeCalculated") < (0,libram__WEBPACK_IMPORTED_MODULE_2__.get)("skillLevel144")) {
...
if ((0,libram__WEBPACK_IMPORTED_MODULE_2__.get)("_deckCardsDrawn") === 0) {
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.cliExecute)("cheat ancestral recall"); // cliExecute("cheat 1952");
...
if ((0,libram__WEBPACK_IMPORTED_MODULE_2__.get)("_deckCardsDrawn") < 11) {
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.useFamiliar)((0,libram__WEBPACK_IMPORTED_MODULE_2__.$familiar)(_templateObject8 || (_templateObject8 = _taggedTemplateLiteral(["robortender"]))));
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.retrieveItem)((0,libram__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject9 || (_templateObject9 = _taggedTemplateLiteral(["toggle switch (bartend)"]))));
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.equip)((0,libram__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["toggle switch (bartend)"]))));
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.restoreMp)(150);
  libram__WEBPACK_IMPORTED_MODULE_2__.Macro.skill((0,libram__WEBPACK_IMPORTED_MODULE_2__.$skill)(_templateObject11 || (_templateObject11 = _taggedTemplateLiteral(["curse of weaksauce"])))).trySkillRepeat((0,libram__WEBPACK_IMPORTED_MODULE_2__.$skill)(_templateObject12 || (_templateObject12 = _taggedTemplateLiteral(["saucestorm"])))).setAutoAttack();
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.cliExecute)("cheat phylum elf");
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.runCombat)(); // putShop(0, 0, $item`peppermint sprig`);
}

if ((0,libram__WEBPACK_IMPORTED_MODULE_2__.get)("_chateauMonsterFought") === false) {
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.useFamiliar)((0,libram__WEBPACK_IMPORTED_MODULE_2__.$familiar)(_templateObject13 || (_templateObject13 = _taggedTemplateLiteral(["robortender"]))));
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.retrieveItem)((0,libram__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject14 || (_templateObject14 = _taggedTemplateLiteral(["toggle switch (bartend)"]))));
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.equip)((0,libram__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject15 || (_templateObject15 = _taggedTemplateLiteral(["toggle switch (bartend)"]))));
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.restoreMp)(150);
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.setAutoAttack)("gnat extract mortar weak");
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.visitUrl)("place.php?whichplace=chateau&action=chateau_painting", false);
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.runCombat)();
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.setAutoAttack)(0); // putShop(0, 0, 1, $item`peppermint sprig`);
}

(0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.cliExecute)("shower cold");
(0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.cliExecute)("bastille mainstat brutalist gesture");
(0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.cliExecute)("briefcase collect");

if (!(0,libram__WEBPACK_IMPORTED_MODULE_2__.get)("_timeSpinnerReplicatorUsed")) {
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.cliExecute)("farfuture gin");
}

(0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.cliExecute)("detective solver");
...
(0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.visitUrl)("place.php?whichplace=chateau&action=chateau_desk1"); // Upgrade saber for fam wt
...
(0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.retrieveItem)(5, (0,libram__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject16 || (_templateObject16 = _taggedTemplateLiteral(["abstraction:thought"])))); // TODO: Make this not break when you run out of macros

while ((0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.toInt)((0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.getProperty)("_machineTunnelsAdv")) < 5) {
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.useFamiliar)((0,libram__WEBPACK_IMPORTED_MODULE_2__.$familiar)(_templateObject17 || (_templateObject17 = _taggedTemplateLiteral(["machine elf"])))); // setAutoAttack("melfgetcertainty");

  libram__WEBPACK_IMPORTED_MODULE_2__.Macro.if_("monsterid 1965", libram__WEBPACK_IMPORTED_MODULE_2__.Macro.trySkillRepeat((0,libram__WEBPACK_IMPORTED_MODULE_2__.$skill)(_templateObject18 || (_templateObject18 = _taggedTemplateLiteral(["saucestorm"]))))).while_("!monstername perceiver of sensations && hasskill macrometeorite", libram__WEBPACK_IMPORTED_MODULE_2__.Macro.trySkill((0,libram__WEBPACK_IMPORTED_MODULE_2__.$skill)(_templateObject19 || (_templateObject19 = _taggedTemplateLiteral(["macrometeorite"])))).skill((0,libram__WEBPACK_IMPORTED_MODULE_2__.$skill)(_templateObject20 || (_templateObject20 = _taggedTemplateLiteral(["summon love mosquito"]))))).if_("monstername perceiver of sensations", libram__WEBPACK_IMPORTED_MODULE_2__.Macro.tryItem((0,libram__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject21 || (_templateObject21 = _taggedTemplateLiteral(["abstraction:thought"])))).trySkillRepeat((0,libram__WEBPACK_IMPORTED_MODULE_2__.$skill)(_templateObject22 || (_templateObject22 = _taggedTemplateLiteral(["saucestorm"]))))).trySkillRepeat((0,libram__WEBPACK_IMPORTED_MODULE_2__.$skill)(_templateObject23 || (_templateObject23 = _taggedTemplateLiteral(["saucestorm"])))).setAutoAttack();
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.adv1)((0,libram__WEBPACK_IMPORTED_MODULE_2__.$location)(_templateObject24 || (_templateObject24 = _taggedTemplateLiteral(["The Deep Machine Tunnels"]))), -1, "");
}

(0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.setAutoAttack)(0);
(0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.useFamiliar)((0,libram__WEBPACK_IMPORTED_MODULE_2__.$familiar)(_templateObject25 || (_templateObject25 = _taggedTemplateLiteral(["rogue program"]))));

if ((0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.availableAmount)((0,libram__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject26 || (_templateObject26 = _taggedTemplateLiteral(["pantsgiving"])))) === 0) {
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.takeStash)(1, (0,libram__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject27 || (_templateObject27 = _taggedTemplateLiteral(["pantsgiving"]))));
}

(0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.equip)((0,libram__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject28 || (_templateObject28 = _taggedTemplateLiteral(["pantsgiving"]))));

while ((0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.toInt)((0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.getProperty)("_snojoFreeFights")) < 10) {
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.setAutoAttack)("gnat extract mortar weak");
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.adv1)((0,libram__WEBPACK_IMPORTED_MODULE_2__.$location)(_templateObject29 || (_templateObject29 = _taggedTemplateLiteral(["x-32 combat training snowman"]))), -1, "");
}

(0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.setAutoAttack)(0);
(0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.equip)((0,libram__WEBPACK_IMPORTED_MODULE_2__.$slot)(_templateObject30 || (_templateObject30 = _taggedTemplateLiteral(["pants"]))), (0,libram__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject31 || (_templateObject31 = _taggedTemplateLiteral(["none"]))));

if ((0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.availableAmount)((0,libram__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject32 || (_templateObject32 = _taggedTemplateLiteral(["pantsgiving"])))) > 0) {
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.putStash)(1, (0,libram__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject33 || (_templateObject33 = _taggedTemplateLiteral(["pantsgiving"]))));
}

(0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.use)(1, (0,libram__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject34 || (_templateObject34 = _taggedTemplateLiteral(["Bird-a-Day Calendar"])))); // cheesefax fortune
//BafH
//Get Free Volcoino
...
if (!(0,libram__WEBPACK_IMPORTED_MODULE_2__.get)("_loveTunnelUsed")) {
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.useFamiliar)((0,libram__WEBPACK_IMPORTED_MODULE_2__.$familiar)(_templateObject35 || (_templateObject35 = _taggedTemplateLiteral(["golden monkey"]))));
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.equip)((0,libram__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject36 || (_templateObject36 = _taggedTemplateLiteral(["fourth of may cosplay saber"]))));
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.useSkill)((0,libram__WEBPACK_IMPORTED_MODULE_2__.$skill)(_templateObject37 || (_templateObject37 = _taggedTemplateLiteral(["carol of the bulls"]))));
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.useSkill)((0,libram__WEBPACK_IMPORTED_MODULE_2__.$skill)(_templateObject38 || (_templateObject38 = _taggedTemplateLiteral(["carol of the hells"]))));
  ...
  (0,_lib__WEBPACK_IMPORTED_MODULE_1__.setChoice)(1228, 2); // Take emotionalizer

  (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.setAutoAttack)("HCCS_LOV_tunnel");
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.adv1)((0,libram__WEBPACK_IMPORTED_MODULE_2__.$location)(_templateObject39 || (_templateObject39 = _taggedTemplateLiteral(["The Tunnel of L.O.V.E."]))), -1, "");
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.setAutoAttack)(0);
}

if ((0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.myGardenType)() === "thanksgarden" && !(0,libram__WEBPACK_IMPORTED_MODULE_2__.get)("_mushroomGardenVisited")) {
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.cliExecute)("garden pick");
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.use)(1, (0,libram__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject40 || (_templateObject40 = _taggedTemplateLiteral(["packet of tall grass seeds"]))));
}

(0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.putShop)(6845, 0, (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.availableAmount)((0,libram__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject41 || (_templateObject41 = _taggedTemplateLiteral(["battery (AAA)"])))), (0,libram__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject42 || (_templateObject42 = _taggedTemplateLiteral(["battery (AAA)"]))));
(0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.putShop)(0, 0, (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.availableAmount)((0,libram__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject43 || (_templateObject43 = _taggedTemplateLiteral(["cornucopia"])))), (0,libram__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject44 || (_templateObject44 = _taggedTemplateLiteral(["cornucopia"]))));
(0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.putShop)(49995, 0, 3, (0,libram__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject45 || (_templateObject45 = _taggedTemplateLiteral(["pocket wish"]))));

if ((0,libram__WEBPACK_IMPORTED_MODULE_2__.get)("_cargoPocketEmptied") === false && !(0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.containsText)((0,libram__WEBPACK_IMPORTED_MODULE_2__.get)("cargoPocketsEmptied"), "533")) {
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.cliExecute)("cargo 533");
  (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.putShop)(50000, 0, (0,kolmafia__WEBPACK_IMPORTED_MODULE_0__.availableAmount)((0,libram__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject46 || (_templateObject46 = _taggedTemplateLiteral(["greasy desk bell"])))), (0,libram__WEBPACK_IMPORTED_MODULE_2__.$item)(_templateObject47 || (_templateObject47 = _taggedTemplateLiteral(["greasy desk bell"]))));
}
...
/******/ 	var __webpack_exports__ = __webpack_require__(__webpack_require__.s = "./src/mannyBreakfast.ts");
