...
function mannyRollover() {
  ...
  if (get("_glitchMonsterFights") === 0) {
    Macro.trySkillRepeat($skill(_templateObject47 || (_templateObject47 = _taggedTemplateLiteral(["saucegeyser"])))).setAutoAttack();
    cliExecute("/glitch");
  }
  ...
  if (get("_claraBellUsed") === false && myAdventures() > 0) {
    use($item(_templateObject48 || (_templateObject48 = _taggedTemplateLiteral(["clara's bell"]))));
    setChoice(919, 1);

    do {
      adv1($location(_templateObject49 || (_templateObject49 = _taggedTemplateLiteral(["sloppy seconds diner"]))), -1, "");
  ...
  if (myInebriety() === inebrietyLimit() && myFullness() === fullnessLimit()) {
    if (myFamiliar() !== $familiar(_templateObject50 || (_templateObject50 = _taggedTemplateLiteral(["stooper"])))) {
      useFamiliar($familiar(_templateObject51 || (_templateObject51 = _taggedTemplateLiteral(["stooper"]))));
      useSkill($skill(_templateObject52 || (_templateObject52 = _taggedTemplateLiteral(["the ode to booze"]))), 1);

      if (availableAmount($item(_templateObject53 || (_templateObject53 = _taggedTemplateLiteral(["astral pilsner"])))) > 0) {
        drinksilent($item(_templateObject54 || (_templateObject54 = _taggedTemplateLiteral(["astral pilsner"]))));
      } else {
        drinksilent($item(_templateObject55 || (_templateObject55 = _taggedTemplateLiteral(["splendid martini"]))));
      }
    }

    useSkill($skill(_templateObject56 || (_templateObject56 = _taggedTemplateLiteral(["the ode to booze"]))), 1);
    takeStash($item(_templateObject57 || (_templateObject57 = _taggedTemplateLiteral(["tiny plastic sword"]))), 1);
    create($item(_templateObject58 || (_templateObject58 = _taggedTemplateLiteral(["grogtini"]))));
    drinksilent($item(_templateObject59 || (_templateObject59 = _taggedTemplateLiteral(["grogtini"]))));
    putStash($item(_templateObject60 || (_templateObject60 = _taggedTemplateLiteral(["tiny plastic sword"]))), 1);
  } else {
    throw "are you sure you want to overdrink? you have some open organ space"; // print("I hope you overdrank on purpose");
  } // outfit("PVP RO fites");


  useFamiliar($familiar(_templateObject61 || (_templateObject61 = _taggedTemplateLiteral(["trick-or-treating tot"]))));
  maximize("adv", false); // equip($item`lil unicorn costume`);

  while (availableAmount($item(_templateObject62 || (_templateObject62 = _taggedTemplateLiteral(["Pok\xE9-Gro fertilizer"])))) > 1) {
    cliExecute("grow");
  }
  ...
  autosell($item(_templateObject63 || (_templateObject63 = _taggedTemplateLiteral(["cheap sunglasses"]))), itemAmount($item(_templateObject64 || (_templateObject64 = _taggedTemplateLiteral(["cheap sunglasses"])))) - 1);
  autosell($item(_templateObject65 || (_templateObject65 = _taggedTemplateLiteral(["filthy child leash"]))), itemAmount($item(_templateObject66 || (_templateObject66 = _taggedTemplateLiteral(["filthy child leash"])))));
  use(itemAmount($item(_templateObject67 || (_templateObject67 = _taggedTemplateLiteral(["bag of park garbage"])))) - 30, $item(_templateObject68 || (_templateObject68 = _taggedTemplateLiteral(["bag of park garbage"]))));
  use(itemAmount($item(_templateObject69 || (_templateObject69 = _taggedTemplateLiteral(["Gathered Meat-Clip"])))), $item(_templateObject70 || (_templateObject70 = _taggedTemplateLiteral(["Gathered Meat-Clip"]))));
  use(itemAmount($item(_templateObject71 || (_templateObject71 = _taggedTemplateLiteral(["old coin purse"])))), $item(_templateObject72 || (_templateObject72 = _taggedTemplateLiteral(["old coin purse"]))));
  use(itemAmount($item(_templateObject73 || (_templateObject73 = _taggedTemplateLiteral(["old leather wallet"])))), $item(_templateObject74 || (_templateObject74 = _taggedTemplateLiteral(["old leather wallet"]))));
  autosell($item(_templateObject75 || (_templateObject75 = _taggedTemplateLiteral(["expensive camera"]))), itemAmount($item(_templateObject76 || (_templateObject76 = _taggedTemplateLiteral(["expensive camera"])))));
  autosell($item(_templateObject77 || (_templateObject77 = _taggedTemplateLiteral(["bag of gross foreign snacks"]))), itemAmount($item(_templateObject78 || (_templateObject78 = _taggedTemplateLiteral(["bag of gross foreign snacks"])))));
  putShop(300, 0, itemAmount($item(_templateObject79 || (_templateObject79 = _taggedTemplateLiteral(["gold nuggets"])))), $item(_templateObject80 || (_templateObject80 = _taggedTemplateLiteral(["gold nuggets"]))));
  putShop(0, 0, itemAmount($item(_templateObject81 || (_templateObject81 = _taggedTemplateLiteral(["cornucopia"])))), $item(_templateObject82 || (_templateObject82 = _taggedTemplateLiteral(["cornucopia"]))));
  putShop(0, 0, itemAmount($item(_templateObject83 || (_templateObject83 = _taggedTemplateLiteral(["elemental sugarcube"])))), $item(_templateObject84 || (_templateObject84 = _taggedTemplateLiteral(["elemental sugarcube"]))));
  putShop(0, 0, itemAmount($item(_templateObject85 || (_templateObject85 = _taggedTemplateLiteral(["gingerbread cigarette"])))), $item(_templateObject86 || (_templateObject86 = _taggedTemplateLiteral(["gingerbread cigarette"]))));
  putShop(0, 0, itemAmount($item(_templateObject87 || (_templateObject87 = _taggedTemplateLiteral(["abandoned candy"])))), $item(_templateObject88 || (_templateObject88 = _taggedTemplateLiteral(["abandoned candy"]))));
  autosell($item(_templateObject89 || (_templateObject89 = _taggedTemplateLiteral(["meat stack"]))), itemAmount($item(_templateObject90 || (_templateObject90 = _taggedTemplateLiteral(["meat stack"])))));

  if (myGardenType() !== "grass") {
    use(1, $item(_templateObject91 || (_templateObject91 = _taggedTemplateLiteral(["packet of tall grass seeds"]))));
  }

  if (myGardenType() === "grass") {
    use($item(_templateObject92 || (_templateObject92 = _taggedTemplateLiteral(["9761"])))); // fertilizer

    use($item(_templateObject93 || (_templateObject93 = _taggedTemplateLiteral(["packet of thanksgarden seeds"]))));
...
function checkFax() {
  ...
  if (get("photocopyMonster") === $monster(_templateObject94 || (_templateObject94 = _taggedTemplateLiteral(["Knob Goblin Embezzler"])))) return true;
  cliExecute("fax send");
  return false;
}
...
function bishopChain() {
  if (get("_pocketProfessorLectures") < 13 && get("_witchessFights") < 5) {
    useFamiliar($familiar(_templateObject95 || (_templateObject95 = _taggedTemplateLiteral(["pocket professor"]))));
    equip($item(_templateObject96 || (_templateObject96 = _taggedTemplateLiteral(["pocket professor memory chip"]))));
    maximize("familiar weight +equip pocket professor memory chip", false);
    useSkill(1, $skill(_templateObject97 || (_templateObject97 = _taggedTemplateLiteral(["blood bond"]))));
    useSkill(1, $skill(_templateObject98 || (_templateObject98 = _taggedTemplateLiteral(["leash of linguini"]))));
    useSkill(1, $skill(_templateObject99 || (_templateObject99 = _taggedTemplateLiteral(["empathy of the newt"]))));
    cliExecute("witchess");
    cliExecute("beach head 10");
    Macro.trySkill($skill(_templateObject100 || (_templateObject100 = _taggedTemplateLiteral(["lecture on relativity"])))).skill($skill(_templateObject101 || (_templateObject101 = _taggedTemplateLiteral(["candyblast"])))).repeat().setAutoAttack();
...
function embezzlerChain() {
  if (get("_pocketProfessorLectures") === 0 && get("_photocopyUsed") === false) {
    useFamiliar($familiar(_templateObject102 || (_templateObject102 = _taggedTemplateLiteral(["pocket professor"]))));
    equip($item(_templateObject103 || (_templateObject103 = _taggedTemplateLiteral(["pocket professor memory chip"]))));
    maximize("familiar weight +equip pocket professor memory chip", false);
    equip($item(_templateObject104 || (_templateObject104 = _taggedTemplateLiteral(["duct tape shirt"]))));
    useSkill(2, $skill(_templateObject105 || (_templateObject105 = _taggedTemplateLiteral(["blood bond"]))));
    useSkill(2, $skill(_templateObject106 || (_templateObject106 = _taggedTemplateLiteral(["leash of linguini"]))));
    useSkill(2, $skill(_templateObject107 || (_templateObject107 = _taggedTemplateLiteral(["empathy of the newt"])))); // useSkill(2, $skill`polka of plenty`);
    ...
    Macro.trySkill($skill(_templateObject108 || (_templateObject108 = _taggedTemplateLiteral(["lecture on relativity"])))).skill($skill(_templateObject109 || (_templateObject109 = _taggedTemplateLiteral(["sing along"])))).skill($skill(_templateObject110 || (_templateObject110 = _taggedTemplateLiteral(["candyblast"])))).repeat().setAutoAttack();
    ...
    use(1, $item(_templateObject111 || (_templateObject111 = _taggedTemplateLiteral(["photocopied monster"]))));
...
function mannyQuestVolcoino() {
  ...
  if ((0,dist.get)("_volcanoItem2") === 8425) {
    (0,external_kolmafia_.retrieveItem)(5, (0,dist.$item)(_templateObject112 || (_templateObject112 = _taggedTemplateLiteral(["new age healing crystal"]))));
    (0,external_kolmafia_.visitUrl)("place.php?whichplace=airport_hot&action=airport4_questhub");
    (0,external_kolmafia_.runChoice)(2);
  } else if ((0,dist.get)("_volcanoItem3") === 8446) {
    (0,external_kolmafia_.retrieveItem)(1, (0,dist.$item)(_templateObject113 || (_templateObject113 = _taggedTemplateLiteral(["SMOOCH bottlecap"]))));
    (0,external_kolmafia_.visitUrl)("place.php?whichplace=airport_hot&action=airport4_questhub");
    (0,external_kolmafia_.runChoice)(3);
  } else if ((0,dist.get)("_volcanoItem3") === 8517) {
    (0,external_kolmafia_.retrieveItem)(3, (0,dist.$item)(_templateObject114 || (_templateObject114 = _taggedTemplateLiteral(["SMOOCH bracers"]))));
    (0,external_kolmafia_.visitUrl)("place.php?whichplace=airport_hot&action=airport4_questhub");
    (0,external_kolmafia_.runChoice)(3);
  } else if ((0,dist.get)("_volcanoItem1") === 8470) {
    (0,external_kolmafia_.retrieveItem)(5, (0,dist.$item)(_templateObject115 || (_templateObject115 = _taggedTemplateLiteral(["gooey lava globs"]))));
    (0,external_kolmafia_.visitUrl)("place.php?whichplace=airport_hot&action=airport4_questhub");
    (0,external_kolmafia_.runChoice)(1);
  } else if ((0,dist.get)("_volcanoItem1") === 8516) {
    (0,external_kolmafia_.retrieveItem)(3, (0,dist.$item)(_templateObject116 || (_templateObject116 = _taggedTemplateLiteral(["smooth velvet bra"]))));
    (0,external_kolmafia_.visitUrl)("place.php?whichplace=airport_hot&action=airport4_questhub");
    (0,external_kolmafia_.runChoice)(1);
  } else if ((0,dist.get)("_volcanoItem1") === 8523) {
    if (!(0,dist.get)("_claraBellUsed") && (0,external_kolmafia_.itemAmount)((0,dist.$item)(_templateObject117 || (_templateObject117 = _taggedTemplateLiteral(["fused fuse"])))) === 0) {
      (0,external_kolmafia_.use)((0,dist.$item)(_templateObject118 || (_templateObject118 = _taggedTemplateLiteral(["clara's bell"]))));
      setChoice(1091, 7);

      while ((0,external_kolmafia_.itemAmount)((0,dist.$item)(_templateObject119 || (_templateObject119 = _taggedTemplateLiteral(["fused fuse"])))) === 0) {
        (0,external_kolmafia_.adv1)((0,dist.$location)(_templateObject120 || (_templateObject120 = _taggedTemplateLiteral(["lavaco lamp factory"]))), -1, "");
      }

      (0,external_kolmafia_.visitUrl)("place.php?whichplace=airport_hot&action=airport4_questhub");
      (0,external_kolmafia_.runChoice)(1);
    } else if (!(0,dist.get)("_freePillKeeperUsed")) {
      (0,external_kolmafia_.cliExecute)("pillkeeper free noncombat");
      setChoice(1091, 7);

      while ((0,external_kolmafia_.itemAmount)((0,dist.$item)(_templateObject121 || (_templateObject121 = _taggedTemplateLiteral(["fused fuse"])))) === 0) {
        (0,external_kolmafia_.adv1)((0,dist.$location)(_templateObject122 || (_templateObject122 = _taggedTemplateLiteral(["lavaco lamp factory"]))), -1, "");
      }

      (0,external_kolmafia_.visitUrl)("place.php?whichplace=airport_hot&action=airport4_questhub");
      (0,external_kolmafia_.runChoice)(1);
    } else {
      (0,external_kolmafia_.print)("You need a fused fuse but can't force a NC for free. :(", "red");
    }
  }
}
;// CONCATENATED MODULE: ./src/postloop.ts
var postloop_templateObject, postloop_templateObject2, postloop_templateObject3, postloop_templateObject4, postloop_templateObject5, postloop_templateObject6, postloop_templateObject7, postloop_templateObject8, postloop_templateObject9, postloop_templateObject10, postloop_templateObject11, postloop_templateObject12, postloop_templateObject13, postloop_templateObject14, postloop_templateObject15, postloop_templateObject16, postloop_templateObject17, postloop_templateObject18, postloop_templateObject19, postloop_templateObject20, postloop_templateObject21, postloop_templateObject22, postloop_templateObject23, postloop_templateObject24, postloop_templateObject25, postloop_templateObject26, postloop_templateObject27, postloop_templateObject28, postloop_templateObject29, postloop_templateObject30, postloop_templateObject31, postloop_templateObject32, postloop_templateObject33, postloop_templateObject34, postloop_templateObject35, postloop_templateObject36, postloop_templateObject37, postloop_templateObject38, postloop_templateObject39;

function postloop_taggedTemplateLiteral(strings, raw) { if (!raw) { raw = strings.slice(0); } return Object.freeze(Object.defineProperties(strings, { raw: { value: Object.freeze(raw) } })); }
...
function getVolcoino() {
  if ((0,dist.get)("_infernoDiscoVisited") === true) return;
  (0,external_kolmafia_.print)("Attempting to rock Disco Style...");

  if ((0,external_kolmafia_.outfit)("Velvet")) {
    (0,external_kolmafia_.visitUrl)("place.php?whichplace=airport_hot&action=airport4_zone1");
    (0,external_kolmafia_.runChoice)(7);
  } else (0,external_kolmafia_.print)("Failed to claim Volcoino.", "red");
}

function getFunFunds() {
  if ((0,dist.get)("_dinseyGarbageDisposed") === true) return;
  (0,external_kolmafia_.print)("Attempting to turn in garbage...");

  if ((0,external_kolmafia_.itemAmount)((0,dist.$item)(postloop_templateObject || (postloop_templateObject = postloop_taggedTemplateLiteral(["bag of park garbage"])))) < 1) {
    if ((0,external_kolmafia_.canInteract)()) {
      (0,external_kolmafia_.buy)(1, (0,dist.$item)(postloop_templateObject2 || (postloop_templateObject2 = postloop_taggedTemplateLiteral(["bag of park garbage"]))));
    } else {
      (0,external_kolmafia_.takeStorage)(1, (0,dist.$item)(postloop_templateObject3 || (postloop_templateObject3 = postloop_taggedTemplateLiteral(["bag of park garbage"]))));
    }
  }

  if ((0,external_kolmafia_.itemAmount)((0,dist.$item)(postloop_templateObject4 || (postloop_templateObject4 = postloop_taggedTemplateLiteral(["bag of park garbage"])))) >= 1) {
  ...
  } else (0,external_kolmafia_.print)("Failed to claim FunFunds.", "red");
}

(0,external_kolmafia_.print)("I really hope this works!", "blue");
(0,external_kolmafia_.cliExecute)("pull * cold hi mein"); // cliExecute("pull * karma shawarma");
// cliExecute("pull * warbear gyro");

(0,external_kolmafia_.cliExecute)("pull 1 bottle of greedy dog");
(0,external_kolmafia_.cliExecute)("pull * lime");
(0,external_kolmafia_.cliExecute)("pull * magical sausage");
(0,external_kolmafia_.cliExecute)("pull * bottle of gin");
(0,external_kolmafia_.cliExecute)("pull * bottle of rum");
(0,external_kolmafia_.cliExecute)("pull * elemental caipiroska");
(0,external_kolmafia_.cliExecute)("pull * abstraction: thought");
(0,external_kolmafia_.cliExecute)("pull * fish sauce");
(0,external_kolmafia_.cliExecute)("pull * stench jelly");
(0,external_kolmafia_.cliExecute)("pull * Asdon Martin keyfob");
(0,external_kolmafia_.cliExecute)("pull * bag of park garbage");
(0,external_kolmafia_.cliExecute)("pull * borrowed time");
(0,external_kolmafia_.cliExecute)("pull * brick");
(0,external_kolmafia_.cliExecute)("pull * Clara's bell");
(0,external_kolmafia_.cliExecute)("pull * fishy pipe");
(0,external_kolmafia_.cliExecute)("pull * Freddy Kruegerand");
(0,external_kolmafia_.cliExecute)("pull * heat-resistant sheet metal");
(0,external_kolmafia_.cliExecute)("pull * magical sausage casing");
(0,external_kolmafia_.cliExecute)("pull * mime army shotglass");
(0,external_kolmafia_.cliExecute)("pull * packet of tall grass seeds");
(0,external_kolmafia_.cliExecute)("pull * packet of thanksgarden seeds");
(0,external_kolmafia_.cliExecute)("pull * packet of winter seeds");
(0,external_kolmafia_.cliExecute)("pull * Poke gro fertilizer");
(0,external_kolmafia_.cliExecute)("pull * School of Hard Knocks Diploma");
(0,external_kolmafia_.cliExecute)("pull * plexiglass pith helmet");
(0,external_kolmafia_.cliExecute)("pull * Source essence");
(0,external_kolmafia_.cliExecute)("pull * Special Seasoning");
(0,external_kolmafia_.cliExecute)("pull * sprinkles");
(0,external_kolmafia_.cliExecute)("pull * subscription cocoa dispenser");
(0,external_kolmafia_.cliExecute)("pull * glitch season reward name");
(0,external_kolmafia_.cliExecute)("pull * bauxite beret");
(0,external_kolmafia_.cliExecute)("pull * dreadful fedora");
(0,external_kolmafia_.cliExecute)("pull * hemlock helm");
(0,external_kolmafia_.cliExecute)("pull * papier-mitre");
(0,external_kolmafia_.cliExecute)("pull * PirateRealm party hat");
(0,external_kolmafia_.cliExecute)("pull * smooth velvet hat");
(0,external_kolmafia_.cliExecute)("pull * The Crown of Ed the Undying");
(0,external_kolmafia_.cliExecute)("pull * dreadful glove");
(0,external_kolmafia_.cliExecute)("pull * high-temperature mining drill");
(0,external_kolmafia_.cliExecute)("pull * plexiglass pikestaff");
(0,external_kolmafia_.cliExecute)("pull * Red Roger's red right hand");
(0,external_kolmafia_.cliExecute)("pull * Staff of Simmering Hatred");
(0,external_kolmafia_.cliExecute)("pull * Drunkula's wineglass");
(0,external_kolmafia_.cliExecute)("pull * hobo code binder");
(0,external_kolmafia_.cliExecute)("pull * Red Roger's red left hand");
(0,external_kolmafia_.cliExecute)("pull * bauxite boxers");
(0,external_kolmafia_.cliExecute)("pull * psychic's pslacks");
(0,external_kolmafia_.cliExecute)("pull * smooth velvet pants");
(0,external_kolmafia_.cliExecute)("pull * bauxite bow-tie");
(0,external_kolmafia_.cliExecute)("pull * Crimbolex watch");
(0,external_kolmafia_.cliExecute)("pull * Dreadsylvania Auditor's badge");
(0,external_kolmafia_.cliExecute)("pull * gold skull ring");
(0,external_kolmafia_.cliExecute)("pull * lucky gold ring");
(0,external_kolmafia_.cliExecute)("pull * mafia pinky ring");
(0,external_kolmafia_.cliExecute)("pull * mafia pointer finger ring");
(0,external_kolmafia_.cliExecute)("pull * mafia thumb ring");
(0,external_kolmafia_.cliExecute)("pull * Mr. Cheeng's spectacles");
(0,external_kolmafia_.cliExecute)("pull * offensive moustache");
(0,external_kolmafia_.cliExecute)("pull * Red Roger's red left foot");
(0,external_kolmafia_.cliExecute)("pull * Red Roger's red right foot");
(0,external_kolmafia_.cliExecute)("pull * smooth velvet hanky");
(0,external_kolmafia_.cliExecute)("pull * smooth velvet pocket square");
(0,external_kolmafia_.cliExecute)("pull * smooth velvet socks");
(0,external_kolmafia_.cliExecute)("pull * li'l unicorn costume");
(0,external_kolmafia_.cliExecute)("pull * Pocket Professor memory chip");
(0,external_kolmafia_.cliExecute)("pull * ice hotel bell");
(0,external_kolmafia_.cliExecute)("pull * magical mystery juice");
(0,external_kolmafia_.cliExecute)("pull * New Age healing crystal");
(0,external_kolmafia_.cliExecute)("pull * lucky cat's paw");
(0,external_kolmafia_.cliExecute)("pull * magical mystery juice");
(0,external_kolmafia_.cliExecute)("pull * toggle switch (bartend)");
(0,external_kolmafia_.cliExecute)("pull * toggle switch (bounce)");
(0,external_kolmafia_.cliExecute)("pull 1 etched hourglass");
(0,external_kolmafia_.cliExecute)("pull 1000000 meat");
(0,external_kolmafia_.cliExecute)("refresh all");
(0,external_kolmafia_.setProperty)("autoSatisfyWithNPCs", "true");
(0,external_kolmafia_.buy)(1, (0,dist.$item)(postloop_templateObject5 || (postloop_templateObject5 = postloop_taggedTemplateLiteral(["Queue Du Coq cocktailcrafting kit"]))));
(0,external_kolmafia_.use)(1, (0,dist.$item)(postloop_templateObject6 || (postloop_templateObject6 = postloop_taggedTemplateLiteral(["Queue Du Coq cocktailcrafting kit"]))));
(0,external_kolmafia_.cliExecute)("ccs libramMacro");

if ((0,dist.get)("_clipartSummons") === 0) {
  (0,external_kolmafia_.cliExecute)("create 3 box of familiar jacks");
}

(0,external_kolmafia_.cliExecute)("make 23 magical sausage");

if ((0,dist.get)("_etchedHourglassUsed") === false) {
  (0,external_kolmafia_.use)((0,dist.$item)(postloop_templateObject7 || (postloop_templateObject7 = postloop_taggedTemplateLiteral(["etched hourglass"]))));
}

(0,external_kolmafia_.use)(1, (0,dist.$item)(postloop_templateObject8 || (postloop_templateObject8 = postloop_taggedTemplateLiteral(["packet of tall grass seeds"]))));

if ((0,external_kolmafia_.getWorkshed)() !== (0,dist.$item)(postloop_templateObject9 || (postloop_templateObject9 = postloop_taggedTemplateLiteral(["asdon martin keyfob"])))) {
  (0,external_kolmafia_.use)(1, (0,dist.$item)(postloop_templateObject10 || (postloop_templateObject10 = postloop_taggedTemplateLiteral(["asdon martin keyfob"]))));
}

(0,external_kolmafia_.putStash)(1, (0,dist.$item)(postloop_templateObject11 || (postloop_templateObject11 = postloop_taggedTemplateLiteral(["Little Geneticist DNA-Splicing Lab"]))));
(0,external_kolmafia_.putDisplay)(1, (0,dist.$item)(postloop_templateObject12 || (postloop_templateObject12 = postloop_taggedTemplateLiteral(["Thwaitgold termite statuette"]))));

if ((0,external_kolmafia_.haveEffect)((0,dist.$effect)(postloop_templateObject13 || (postloop_templateObject13 = postloop_taggedTemplateLiteral(["feeling lost"])))) !== 0) {
...
(0,external_kolmafia_.print)("Stone smashed. Get your PVP on!", "green");

if ((0,external_kolmafia_.availableAmount)((0,dist.$item)(postloop_templateObject14 || (postloop_templateObject14 = postloop_taggedTemplateLiteral(["blood-drive sticker"])))) > 10) {
  (0,external_kolmafia_.putShop)(0, 0, 1, (0,dist.$item)(postloop_templateObject15 || (postloop_templateObject15 = postloop_taggedTemplateLiteral(["blood-drive sticker"]))));
}

(0,external_kolmafia_.putShop)(0, 0, 1, (0,dist.$item)(postloop_templateObject16 || (postloop_templateObject16 = postloop_taggedTemplateLiteral(["vintage smart drink"]))));
(0,external_kolmafia_.putShop)(0, 0, 1, (0,dist.$item)(postloop_templateObject17 || (postloop_templateObject17 = postloop_taggedTemplateLiteral(["emergency margarita"]))));
(0,external_kolmafia_.putShop)(0, 0, 1, (0,dist.$item)(postloop_templateObject18 || (postloop_templateObject18 = postloop_taggedTemplateLiteral(["bag of grain"])))); // put_shop(0, 0, 1, $item[squeaky toy rose]);

(0,external_kolmafia_.putShop)(49995, 0, 3, (0,dist.$item)(postloop_templateObject19 || (postloop_templateObject19 = postloop_taggedTemplateLiteral(["pocket wish"]))));
(0,external_kolmafia_.cliExecute)("terminal enquiry familiar.enq");
setChoice(1414, 2);
(0,external_kolmafia_.useSkill)(1, (0,dist.$skill)(postloop_templateObject20 || (postloop_templateObject20 = postloop_taggedTemplateLiteral(["lock picking"]))));
(0,external_kolmafia_.cliExecute)("create 1 jarlsberg's key lime");
(0,external_kolmafia_.putShop)(0, 0, (0,dist.$item)(postloop_templateObject21 || (postloop_templateObject21 = postloop_taggedTemplateLiteral(["jarlsberg's key lime"]))));

if ((0,dist.get)("_deckCardsDrawn") < 11) {
  (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(postloop_templateObject22 || (postloop_templateObject22 = postloop_taggedTemplateLiteral(["robortender"]))));
  (0,external_kolmafia_.retrieveItem)((0,dist.$item)(postloop_templateObject23 || (postloop_templateObject23 = postloop_taggedTemplateLiteral(["toggle switch (bartend)"]))));
  (0,external_kolmafia_.equip)((0,dist.$item)(postloop_templateObject24 || (postloop_templateObject24 = postloop_taggedTemplateLiteral(["toggle switch (bartend)"]))));
  (0,external_kolmafia_.restoreMp)(150);
  dist.Macro.skill((0,dist.$skill)(postloop_templateObject25 || (postloop_templateObject25 = postloop_taggedTemplateLiteral(["curse of weaksauce"])))).trySkillRepeat((0,dist.$skill)(postloop_templateObject26 || (postloop_templateObject26 = postloop_taggedTemplateLiteral(["saucegeyser"])))).setAutoAttack();
  (0,external_kolmafia_.cliExecute)("cheat phylum elf");
  (0,external_kolmafia_.runCombat)();
  (0,external_kolmafia_.setAutoAttack)(0); // putShop(0, 0, $item`peppermint sprig`);
...
(0,external_kolmafia_.cliExecute)("farfuture gin"); // cli_execute('timespinner prank reverkiller');
// chat_private('reverkiller', 'you done just got PRANKED!');

while ((0,external_kolmafia_.toInt)((0,external_kolmafia_.getProperty)("_sourceTerminalExtrudes")) < 3) {
  (0,external_kolmafia_.cliExecute)("terminal extrude booze"); // SourceTerminal.extrude($item`hacked gibson`);
}

while ((0,dist.get)("_clipartSummons") < 3) {
  (0,external_kolmafia_.cliExecute)("create 1 box of familiar jacks");
} // dupe a greedy dog


var dupeTarget = (0,dist.$item)(postloop_templateObject27 || (postloop_templateObject27 = postloop_taggedTemplateLiteral(["bottle of greedy dog"])));

if ((0,external_kolmafia_.toInt)((0,external_kolmafia_.getProperty)("encountersUntilDMTChoice")) === 0 && (0,external_kolmafia_.availableAmount)(dupeTarget) > 0) {
  (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(postloop_templateObject28 || (postloop_templateObject28 = postloop_taggedTemplateLiteral(["machine elf"]))));
  setChoice(1119, 4); // setProperty("choiceAdventure1119", "4");

  (0,external_kolmafia_.setProperty)("choiceAdventure1125", "1&iid=".concat((0,external_kolmafia_.toInt)(dupeTarget)));
  (0,external_kolmafia_.adv1)((0,dist.$location)(postloop_templateObject29 || (postloop_templateObject29 = postloop_taggedTemplateLiteral(["the deep machine tunnels"]))), -1, ""); // putShop(0, 0, 1, $item`Karma shawarma`);

  (0,external_kolmafia_.putCloset)(2, dupeTarget);
} else {
  (0,external_kolmafia_.print)("Something went wrong duping a ".concat(dupeTarget.name), "red");
} // TODO: get doggie volcoino and superduper


(0,external_kolmafia_.retrieveItem)(20, (0,dist.$item)(postloop_templateObject30 || (postloop_templateObject30 = postloop_taggedTemplateLiteral(["heat-resistant sheet metal"])))); // setAutoAttack("gnat extract mortar weak");

dist.Macro.trySkill((0,dist.$skill)(postloop_templateObject31 || (postloop_templateObject31 = postloop_taggedTemplateLiteral(["curse of weaksauce"])))).trySkill((0,dist.$skill)(postloop_templateObject32 || (postloop_templateObject32 = postloop_taggedTemplateLiteral(["stuffed mortar shell"])))).trySkill((0,dist.$skill)(postloop_templateObject33 || (postloop_templateObject33 = postloop_taggedTemplateLiteral(["extract"])))).setAutoAttack();

while (!(0,external_kolmafia_.containsText)((0,dist.$location)(postloop_templateObject34 || (postloop_templateObject34 = postloop_taggedTemplateLiteral(["bubblin' caldera"], ["bubblin\\' caldera"]))).noncombatQueue, "Lava Dogs")) {
  (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(postloop_templateObject35 || (postloop_templateObject35 = postloop_taggedTemplateLiteral(["mini-hipster"]))));
  (0,external_kolmafia_.equip)((0,dist.$item)(postloop_templateObject36 || (postloop_templateObject36 = postloop_taggedTemplateLiteral(["Kramco Sausage-o-Matic"]))));
  (0,external_kolmafia_.adv1)((0,dist.$location)(postloop_templateObject37 || (postloop_templateObject37 = postloop_taggedTemplateLiteral(["bubblin' caldera"], ["bubblin\\' caldera"]))));
}
...
(0,external_kolmafia_.putShop)(6845, 0, (0,external_kolmafia_.availableAmount)((0,dist.$item)(postloop_templateObject38 || (postloop_templateObject38 = postloop_taggedTemplateLiteral(["battery (AAA)"])))), (0,dist.$item)(postloop_templateObject39 || (postloop_templateObject39 = postloop_taggedTemplateLiteral(["battery (AAA)"]))));
mannyQuestVolcoino();

if ((0,dist.get)("_unaccompaniedMinerUsed") === 0) {
  (0,external_kolmafia_.cliExecute)("minevolcano 5");
}
...
/******/ 	var __webpack_exports__ = __webpack_require__(__webpack_require__.s = 3368);
