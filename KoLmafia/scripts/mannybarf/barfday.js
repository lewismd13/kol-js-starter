...
function checkFax() {
  ...
  if ((0,dist.get)("photocopyMonster") === (0,dist.$monster)(_templateObject94 || (_templateObject94 = _taggedTemplateLiteral(["Knob Goblin Embezzler"])))) return true;
...
function embezzlerChain() {
  if ((0,dist.get)("_pocketProfessorLectures") === 0 && (0,dist.get)("_photocopyUsed") === false) {
    (0,external_kolmafia_.useFamiliar)((0,dist.$familiar)(_templateObject102 || (_templateObject102 = _taggedTemplateLiteral(["pocket professor"]))));
    (0,external_kolmafia_.equip)((0,dist.$item)(_templateObject103 || (_templateObject103 = _taggedTemplateLiteral(["pocket professor memory chip"]))));
    (0,external_kolmafia_.maximize)("familiar weight +equip pocket professor memory chip", false);
    (0,external_kolmafia_.equip)((0,dist.$item)(_templateObject104 || (_templateObject104 = _taggedTemplateLiteral(["duct tape shirt"]))));
    (0,external_kolmafia_.useSkill)(2, (0,dist.$skill)(_templateObject105 || (_templateObject105 = _taggedTemplateLiteral(["blood bond"]))));
    (0,external_kolmafia_.useSkill)(2, (0,dist.$skill)(_templateObject106 || (_templateObject106 = _taggedTemplateLiteral(["leash of linguini"]))));
    (0,external_kolmafia_.useSkill)(2, (0,dist.$skill)(_templateObject107 || (_templateObject107 = _taggedTemplateLiteral(["empathy of the newt"])))); // useSkill(2, $skill`polka of plenty`);
    ...
    dist.Macro.trySkill((0,dist.$skill)(_templateObject108 || (_templateObject108 = _taggedTemplateLiteral(["lecture on relativity"])))).skill((0,dist.$skill)(_templateObject109 || (_templateObject109 = _taggedTemplateLiteral(["sing along"])))).skill((0,dist.$skill)(_templateObject110 || (_templateObject110 = _taggedTemplateLiteral(["candyblast"])))).repeat().setAutoAttack();
    ...
    (0,external_kolmafia_.use)(1, (0,dist.$item)(_templateObject111 || (_templateObject111 = _taggedTemplateLiteral(["photocopied monster"]))));
...
function mannyQuestVolcoino() {
  ...
  if (get("_volcanoItem2") === 8425) {
    retrieveItem(5, $item(_templateObject112 || (_templateObject112 = _taggedTemplateLiteral(["new age healing crystal"]))));
    visitUrl("place.php?whichplace=airport_hot&action=airport4_questhub");
    runChoice(2);
  } else if (get("_volcanoItem3") === 8446) {
    retrieveItem(1, $item(_templateObject113 || (_templateObject113 = _taggedTemplateLiteral(["SMOOCH bottlecap"]))));
    visitUrl("place.php?whichplace=airport_hot&action=airport4_questhub");
    runChoice(3);
  } else if (get("_volcanoItem3") === 8517) {
    retrieveItem(3, $item(_templateObject114 || (_templateObject114 = _taggedTemplateLiteral(["SMOOCH bracers"]))));
    visitUrl("place.php?whichplace=airport_hot&action=airport4_questhub");
    runChoice(3);
  } else if (get("_volcanoItem1") === 8470) {
    retrieveItem(5, $item(_templateObject115 || (_templateObject115 = _taggedTemplateLiteral(["gooey lava globs"]))));
    visitUrl("place.php?whichplace=airport_hot&action=airport4_questhub");
    runChoice(1);
  } else if (get("_volcanoItem1") === 8516) {
    retrieveItem(3, $item(_templateObject116 || (_templateObject116 = _taggedTemplateLiteral(["smooth velvet bra"]))));
    visitUrl("place.php?whichplace=airport_hot&action=airport4_questhub");
    runChoice(1);
  } else if (get("_volcanoItem1") === 8523) {
    if (!get("_claraBellUsed") && itemAmount($item(_templateObject117 || (_templateObject117 = _taggedTemplateLiteral(["fused fuse"])))) === 0) {
      use($item(_templateObject118 || (_templateObject118 = _taggedTemplateLiteral(["clara's bell"]))));
      setChoice(1091, 7);
      ...
      while (itemAmount($item(_templateObject121 || (_templateObject121 = _taggedTemplateLiteral(["fused fuse"])))) === 0) {
        adv1($location(_templateObject122 || (_templateObject122 = _taggedTemplateLiteral(["lavaco lamp factory"]))), -1, "");
      }
...
if ((0,external_kolmafia_.myInebriety)() === 0) {
  ...
  if ((0,external_kolmafia_.inebrietyLimit)() === 20 && (0,external_kolmafia_.myInebriety)() === 15) {
    (0,external_kolmafia_.drinksilent)(1, (0,dist.$item)(barfday_templateObject24 || (barfday_templateObject24 = barfday_taggedTemplateLiteral(["frosty's frosty mug"], ["frosty\\'s frosty mug"]))));
...
if ((0,external_kolmafia_.mySpleenUse)() === (0,external_kolmafia_.spleenLimit)() && (0,external_kolmafia_.haveEffect)((0,dist.$effect)(barfday_templateObject31 || (barfday_templateObject31 = barfday_taggedTemplateLiteral(["eau d' clochard"], ["eau d\\' clochard"])))) === 0 && (0,dist.get)("currentMojoFilters") < 3) {
  ...
  (0,external_kolmafia_.retrieveItem)((0,dist.$item)(barfday_templateObject34 || (barfday_templateObject34 = barfday_taggedTemplateLiteral(["beggin' cologne"], ["beggin\\' cologne"]))));
  (0,external_kolmafia_.use)((0,dist.$item)(barfday_templateObject35 || (barfday_templateObject35 = barfday_taggedTemplateLiteral(["beggin' cologne"], ["beggin\\' cologne"]))));
}
...
if (!(0,dist.get)("_mimeArmyShotglassUsed") && !(0,dist.get)("_syntheticDogHairPillUsed")) {
  (0,external_kolmafia_.use)(1, (0,dist.$item)(barfday_templateObject40 || (barfday_templateObject40 = barfday_taggedTemplateLiteral(["synthetic doghair pill"]))));
...
while ((0,external_kolmafia_.haveEffect)((0,dist.$effect)(barfday_templateObject58 || (barfday_templateObject58 = barfday_taggedTemplateLiteral(["Fat Leon's Phat Loot Lyric"], ["Fat Leon\\'s Phat Loot Lyric"])))) < calculateFarmingTurns()) {
...
if ((0,dist.get)("_backUpUses") === 10 && (0,external_kolmafia_.getProperty)("lastCopyableMonster") === (0,dist.$monster)(barfday_templateObject116 || (barfday_templateObject116 = barfday_taggedTemplateLiteral(["Knob Goblin Embezzler"]))).name) {
  ...
  .trySkill((0,dist.$skill)(barfday_templateObject122 || (barfday_templateObject122 = barfday_taggedTemplateLiteral(["sing along"])))).skill((0,dist.$skill)(_templateObject123 || (_templateObject123 = barfday_taggedTemplateLiteral(["summer siesta"])))).trySkillRepeat((0,dist.$skill)(_templateObject124 || (_templateObject124 = barfday_taggedTemplateLiteral(["candyblast"])))));
  (0,external_kolmafia_.setAutoAttack)(0);
}
